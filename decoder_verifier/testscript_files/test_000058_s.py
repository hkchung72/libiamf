...
no_of_check_items += 1
if "stts_0000000000010373" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["stts_0000000000010373"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_000000000001038b" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stsc_000000000001038b"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000103a7" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stco_00000000000103a7"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000000103bb" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsz_00000000000103bb"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
