...
parser = argparse.ArgumentParser(description="test_000409_s verification script")
...
no_of_check_items += 1
if "iacb_00000000001d6777" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["iacb_00000000001d6777"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "stts_00000000001d68ba" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_00000000001d68ba"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000001d68da" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_00000000001d68da"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000001d6902" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_00000000001d6902"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000001d693e" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_00000000001d693e"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
