...
no_of_check_items += 1
if "stts_00000000001d68af" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["stts_00000000001d68af"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000001d68cf" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stsc_00000000001d68cf"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000001d68f7" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stco_00000000001d68f7"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000001d6933" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsz_00000000001d6933"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
