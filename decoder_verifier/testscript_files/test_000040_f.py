...
parser = argparse.ArgumentParser(description="test_000040_f verification script")
...
if "tfhd_0000000000000333" in atom_list[17]:
	...
	if atom[4]["DefaultSampleDuration"] == 64:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[5]["DefaultSampleSize"] == 402:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "trun_0000000000000363" in atom_list[18]:
	pass_count += 1
	atom = atom_list[18]["trun_0000000000000363"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
