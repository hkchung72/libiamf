...
no_of_check_items += 1
if "stts_00000000000084df" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["stts_00000000000084df"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000084f7" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stsc_00000000000084f7"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000008513" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stco_0000000000008513"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000008527" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsz_0000000000008527"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
