...
no_of_check_items += 1
if "stco_0000000000008589" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_0000000000008589"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_000000000000859d" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_000000000000859d"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
