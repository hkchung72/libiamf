...
no_of_check_items += 1
if "stts_000000000000854a" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_000000000000854a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_000000000000856a" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_000000000000856a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000008586" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_0000000000008586"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_000000000000859a" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_000000000000859a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
