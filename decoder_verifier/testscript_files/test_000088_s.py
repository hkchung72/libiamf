...
parser = argparse.ArgumentParser(description="test_000088_s verification script")
...
no_of_check_items += 1
if "iacb_000000000000826e" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["iacb_000000000000826e"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "stts_00000000000082fc" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_00000000000082fc"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000008314" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_0000000000008314"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_000000000000833c" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_000000000000833c"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000008354" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_0000000000008354"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
