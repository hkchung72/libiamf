...
no_of_check_items += 1
if "stts_00000000000002fa" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stts_00000000000002fa"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_000000000000030a" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsc_000000000000030a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_000000000000031a" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stco_000000000000031a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_000000000000032a" in atom_list[15]:
	pass_count += 1
	atom = atom_list[15]["stsz_000000000000032a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "moof_000000000000037a" in atom_list[16]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "traf_0000000000000392" in atom_list[17]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tfhd_000000000000039a" in atom_list[18]:
	pass_count += 1
	atom = atom_list[18]["tfhd_000000000000039a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trun_00000000000003c2" in atom_list[19]:
	pass_count += 1
	atom = atom_list[19]["trun_00000000000003c2"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
