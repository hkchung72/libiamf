...
parser = argparse.ArgumentParser(description="test_000001_s verification script")
...
no_of_check_items += 1
if "stts_00000000000083df" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_00000000000083df"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000083ff" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_00000000000083ff"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_000000000000841b" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_000000000000841b"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_000000000000842f" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_000000000000842f"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
