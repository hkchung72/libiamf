...
no_of_check_items += 1
if "stts_00000000000002c4" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stts_00000000000002c4"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000002d4" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsc_00000000000002d4"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000002e4" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stco_00000000000002e4"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000000002f4" in atom_list[15]:
	pass_count += 1
	atom = atom_list[15]["stsz_00000000000002f4"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "moof_0000000000000344" in atom_list[16]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "traf_000000000000035c" in atom_list[17]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tfhd_0000000000000364" in atom_list[18]:
	pass_count += 1
	atom = atom_list[18]["tfhd_0000000000000364"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trun_000000000000038c" in atom_list[19]:
	pass_count += 1
	atom = atom_list[19]["trun_000000000000038c"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
for demixing.""")
print("is_valid: True")
print("primary_tested_spec_sections: ['3.6.2/loudspeaker_layout == 7.1.4', '7/IAMF Processing', '7.3.2.1/Rendering a Channel-Based Audio Element to Loudspeakers', '7.5.1/Loudness Normalization', '7.5.2/Limiter', '10.2.1/Annex B-1: Down-mix parameter and Loudness']")
print("*"*40)
