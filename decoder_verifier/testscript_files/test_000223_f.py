...
parser = argparse.ArgumentParser(description="test_000223_f verification script")
...
no_of_check_items += 1
if "stts_00000000000002cf" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stts_00000000000002cf"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000002df" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsc_00000000000002df"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000002ef" in atom_list[15]:
	pass_count += 1
	atom = atom_list[15]["stco_00000000000002ef"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000000002ff" in atom_list[16]:
	pass_count += 1
	atom = atom_list[16]["stsz_00000000000002ff"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "moof_000000000000034f" in atom_list[17]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "traf_0000000000000367" in atom_list[18]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tfhd_000000000000036f" in atom_list[19]:
	pass_count += 1
	atom = atom_list[19]["tfhd_000000000000036f"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trun_0000000000000397" in atom_list[20]:
	pass_count += 1
	atom = atom_list[20]["trun_0000000000000397"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
for demixing.""")
print("is_valid: True")
print("primary_tested_spec_sections: ['3.6.2/loudspeaker_layout == 7.1.4', '7/IAMF Processing', '7.3.2.1/Rendering a Channel-Based Audio Element to Loudspeakers', '7.5.1/Loudness Normalization', '7.5.2/Limiter', '9.1.2.1/Annex A2.1: Down-mix parameter and Loudness']")
print("*"*40)
