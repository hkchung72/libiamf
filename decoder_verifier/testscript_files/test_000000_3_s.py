...
parser = argparse.ArgumentParser(description="test_000000_3_s verification script")
...
no_of_check_items += 1
if "moov_0000000000007de5" in atom_list[1]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "mvhd_0000000000007ded" in atom_list[2]:
	pass_count += 1
	atom = atom_list[2]["mvhd_0000000000007ded"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
	...
	if atom[1]["Flags"] == 0:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[2]["CreationTime"] == "2023-04-06 00:00:00 UTC":
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[3]["ModificationTime"] == "2023-04-06 00:00:00 UTC":
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "trak_0000000000007e59" in atom_list[3]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tkhd_0000000000007e61" in atom_list[4]:
	pass_count += 1
	atom = atom_list[4]["tkhd_0000000000007e61"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "mdhd_0000000000007ec5" in atom_list[5]:
	pass_count += 1
	atom = atom_list[5]["mdhd_0000000000007ec5"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "hdlr_0000000000007ee5" in atom_list[6]:
	pass_count += 1
	atom = atom_list[6]["hdlr_0000000000007ee5"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
	...
	if atom[6]["Reserved3"] == 0:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[7]["Name"] == "ISO Media file produced by Google Inc. Created on: 04/05/2023.":
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stbl_0000000000007f70" in atom_list[7]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stsd_0000000000007f78" in atom_list[8]:
	pass_count += 1
	atom = atom_list[8]["stsd_0000000000007f78"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "iamf_0000000000007f88" in atom_list[9]:
	pass_count += 1
	atom = atom_list[9]["iamf_0000000000007f88"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "iacb_0000000000007fac" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["iacb_0000000000007fac"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "stts_000000000000802e" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_000000000000802e"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_000000000000804e" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_000000000000804e"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_000000000000806a" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_000000000000806a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_000000000000807e" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_000000000000807e"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
print("*"*40)
print("description:")
print("""A simple profile stereo IAMF stream with 1 substream. The
final audio frame incorrectly has fewer samples than all
other frames because it does not have sufficient
`num_samples_to_trim_at_end`""")
print("is_valid: False")
print("primary_tested_spec_sections: ['3.2/num_samples_to_trim_at_end', '3.4/IA Sequence Header OBU Syntax and Semantics', '3.5/num_samples_per_frame', '6.2.2/ia_sample_duration']")
print("*"*40)
