...
no_of_check_items += 1
if "iamd_0000000000007fac" in atom_list[10]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stts_000000000000802a" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_000000000000802a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_000000000000804a" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_000000000000804a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000008066" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_0000000000008066"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_000000000000807a" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_000000000000807a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
print("primary_tested_spec_sections: ['2.6/num_samples_per_frame', '5.2.2/ia_sample_duration']")
print("*"*40)
