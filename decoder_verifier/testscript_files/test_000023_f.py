...
if "iamf_0000000000000207" in atom_list[11]:
	...
	if atom[11]["codec_id"] == "Opus":
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[12]["num_samples_per_frame"] == 240:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[13]["audio_roll_distance"] == -16:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stts_00000000000002aa" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stts_00000000000002aa"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000002ba" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsc_00000000000002ba"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000002ca" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stco_00000000000002ca"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000000002da" in atom_list[15]:
	pass_count += 1
	atom = atom_list[15]["stsz_00000000000002da"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "moof_000000000000032a" in atom_list[16]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "traf_0000000000000342" in atom_list[17]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tfhd_000000000000034a" in atom_list[18]:
	pass_count += 1
	atom = atom_list[18]["tfhd_000000000000034a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trun_0000000000000372" in atom_list[19]:
	pass_count += 1
	atom = atom_list[19]["trun_0000000000000372"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
