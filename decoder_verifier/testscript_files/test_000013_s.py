...
parser = argparse.ArgumentParser(description="test_000013_s verification script")
...
no_of_check_items += 1
if "iamd_0000000000008228" in atom_list[10]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stts_00000000000082b3" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_00000000000082b3"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000082d3" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_00000000000082d3"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000082ef" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_00000000000082ef"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000008303" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_0000000000008303"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
`param_definition_mode` which should fail.""")
print("is_valid: False")
print("primary_tested_spec_sections: ['4.1']")
print("*"*40)
