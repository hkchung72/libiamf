...
parser = argparse.ArgumentParser(description="test_000013 verification script")
...
if "moov_0000000000008120" in atom_list[1]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))

if "mvhd_0000000000008128" in atom_list[2]:
	pass_count += 1
	atom = atom_list[2]["mvhd_0000000000008128"]
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
		frame = inspect.currentframe()
...
if "trak_0000000000008194" in atom_list[3]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))

if "tkhd_000000000000819c" in atom_list[4]:
	pass_count += 1
	atom = atom_list[4]["tkhd_000000000000819c"]
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
		frame = inspect.currentframe()
...
if "mdhd_0000000000008200" in atom_list[5]:
	pass_count += 1
	atom = atom_list[5]["mdhd_0000000000008200"]
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
		frame = inspect.currentframe()
...
if "hdlr_0000000000008220" in atom_list[6]:
	pass_count += 1
	atom = atom_list[6]["hdlr_0000000000008220"]
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
		frame = inspect.currentframe()
...
if "stbl_00000000000082ab" in atom_list[7]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))

if "stsd_00000000000082b3" in atom_list[8]:
	pass_count += 1
	atom = atom_list[8]["stsd_00000000000082b3"]
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
		frame = inspect.currentframe()
...
if "iamf_00000000000082c3" in atom_list[9]:
	pass_count += 1
	atom = atom_list[9]["iamf_00000000000082c3"]
...
if "iamd_00000000000082e7" in atom_list[10]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))

if "stts_0000000000008376" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_0000000000008376"]
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
		frame = inspect.currentframe()
...
if "stsc_0000000000008396" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_0000000000008396"]
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
		frame = inspect.currentframe()
...
if "stsz_00000000000083c6" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsz_00000000000083c6"]
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
		frame = inspect.currentframe()
	...
	if atom[3]["SampleCount"] == 63:
		...
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
		if atom[4]["EntrySize_0"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[5]["EntrySize_1"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[6]["EntrySize_2"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[7]["EntrySize_3"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[8]["EntrySize_4"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[9]["EntrySize_5"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[10]["EntrySize_6"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[11]["EntrySize_7"] == 524:
			...
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[12]["EntrySize_8"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[13]["EntrySize_9"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[14]["EntrySize_10"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[15]["EntrySize_11"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[16]["EntrySize_12"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[17]["EntrySize_13"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[18]["EntrySize_14"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[19]["EntrySize_15"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[20]["EntrySize_16"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[21]["EntrySize_17"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[22]["EntrySize_18"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[23]["EntrySize_19"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[24]["EntrySize_20"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[25]["EntrySize_21"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[26]["EntrySize_22"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[27]["EntrySize_23"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[28]["EntrySize_24"] == 524:
			...
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[29]["EntrySize_25"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[30]["EntrySize_26"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[31]["EntrySize_27"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[32]["EntrySize_28"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[33]["EntrySize_29"] == 524:
			...
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[34]["EntrySize_30"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[35]["EntrySize_31"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[36]["EntrySize_32"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[37]["EntrySize_33"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[38]["EntrySize_34"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[39]["EntrySize_35"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[40]["EntrySize_36"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[41]["EntrySize_37"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[42]["EntrySize_38"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[43]["EntrySize_39"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[44]["EntrySize_40"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[45]["EntrySize_41"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[46]["EntrySize_42"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[47]["EntrySize_43"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[48]["EntrySize_44"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[49]["EntrySize_45"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[50]["EntrySize_46"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[51]["EntrySize_47"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[52]["EntrySize_48"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[53]["EntrySize_49"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[54]["EntrySize_50"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[55]["EntrySize_51"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[56]["EntrySize_52"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[57]["EntrySize_53"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[58]["EntrySize_54"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[59]["EntrySize_55"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[60]["EntrySize_56"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[61]["EntrySize_57"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[62]["EntrySize_58"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[63]["EntrySize_59"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[64]["EntrySize_60"] == 524:
			...
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[65]["EntrySize_61"] == 524:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[66]["EntrySize_62"] == 528:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
...
if "stco_00000000000083b2" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stco_00000000000083b2"]
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
		frame = inspect.currentframe()
