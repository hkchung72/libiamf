...
no_of_check_items += 1
if "stts_00000000000082ab" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_00000000000082ab"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000082cb" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_00000000000082cb"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000082e7" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_00000000000082e7"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000000082fb" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_00000000000082fb"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
print("primary_tested_spec_sections: ['3.1']")
print("*"*40)
