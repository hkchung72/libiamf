...
parser = argparse.ArgumentParser(description="test_000223_s verification script")
...
no_of_check_items += 1
if "stts_0000000000057cf6" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stts_0000000000057cf6"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000057d16" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsc_0000000000057d16"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000057d3e" in atom_list[15]:
	pass_count += 1
	atom = atom_list[15]["stco_0000000000057d3e"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000057d7a" in atom_list[16]:
	pass_count += 1
	atom = atom_list[16]["stsz_0000000000057d7a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "sgpd_000000000005817a" in atom_list[17]:
	pass_count += 1
	atom = atom_list[17]["sgpd_000000000005817a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 1:
		pass_count += 1
	else:
