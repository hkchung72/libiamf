...
parser = argparse.ArgumentParser(description="test_000026_s verification script")
...
no_of_check_items += 1
if "moov_0000000000000e45" in atom_list[1]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "mvhd_0000000000000e4d" in atom_list[2]:
	pass_count += 1
	atom = atom_list[2]["mvhd_0000000000000e4d"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trak_0000000000000eb9" in atom_list[3]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tkhd_0000000000000ec1" in atom_list[4]:
	pass_count += 1
	atom = atom_list[4]["tkhd_0000000000000ec1"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "edts_0000000000000f1d" in atom_list[5]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "elst_0000000000000f25" in atom_list[6]:
	pass_count += 1
	atom = atom_list[6]["elst_0000000000000f25"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "mdhd_0000000000000f49" in atom_list[7]:
	pass_count += 1
	atom = atom_list[7]["mdhd_0000000000000f49"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "hdlr_0000000000000f69" in atom_list[8]:
	pass_count += 1
	atom = atom_list[8]["hdlr_0000000000000f69"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stbl_0000000000000ff4" in atom_list[9]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stsd_0000000000000ffc" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["stsd_0000000000000ffc"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "iamf_000000000000100c" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["iamf_000000000000100c"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "iamd_0000000000001030" in atom_list[12]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stts_00000000000010b4" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stts_00000000000010b4"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000010d4" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsc_00000000000010d4"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000010fc" in atom_list[15]:
	pass_count += 1
	atom = atom_list[15]["stco_00000000000010fc"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000001114" in atom_list[16]:
	pass_count += 1
	atom = atom_list[16]["stsz_0000000000001114"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
	...
	if atom[3]["SampleCount"] == 26:
		...
		print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if atom[4]["EntrySize_0"] == 206:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if atom[5]["EntrySize_1"] == 161:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
	...
	if obu.get("codec_config") is not None:
		...
		if obu["codec_config"].get("decoder_config_opus") is not None:
			...
			if obu["codec_config"]["decoder_config_opus"].get("version") == 1:
				...
				print("failure line is #%d."%(frame.f_lineno))
			no_of_check_items += 1
			if obu["codec_config"]["decoder_config_opus"].get("output_channel_count") == 1:
				pass_count += 1
			else:
				frame = inspect.currentframe()
				print("failure line is #%d."%(frame.f_lineno))
		...
		if sub_mixes[0].get("layouts") is not None:
			...
			if layouts[0].get("loudness") is not None:
				...
				if layouts[0]["loudness"].get("info_type") == 0:
					...
					print("failure line is #%d."%(frame.f_lineno))
				no_of_check_items += 1
				if layouts[0]["loudness"].get("integrated_loudness") == -3122:
					pass_count += 1
				else:
					frame = inspect.currentframe()
					print("failure line is #%d."%(frame.f_lineno))
				no_of_check_items += 1
				if layouts[0]["loudness"].get("digital_peak") == -1741:
					pass_count += 1
				else:
					frame = inspect.currentframe()
					print("failure line is #%d."%(frame.f_lineno))
...
print("*"*40)
print("description:")
print("""A stereo IAMF stream encoded using Opus, with an incorrect
`output_channel_count`.""")
print("is_valid: False")
print("primary_tested_spec_sections: ['3.10', '3.13.1/output_channel_count']")
print("*"*40)
