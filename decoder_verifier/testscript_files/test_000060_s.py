...
parser = argparse.ArgumentParser(description="test_000060_s verification script")
...
no_of_check_items += 1
if "moov_0000000000008287" in atom_list[1]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "mvhd_000000000000828f" in atom_list[2]:
	pass_count += 1
	atom = atom_list[2]["mvhd_000000000000828f"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trak_00000000000082fb" in atom_list[3]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tkhd_0000000000008303" in atom_list[4]:
	pass_count += 1
	atom = atom_list[4]["tkhd_0000000000008303"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "mdhd_0000000000008367" in atom_list[5]:
	pass_count += 1
	atom = atom_list[5]["mdhd_0000000000008367"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "hdlr_0000000000008387" in atom_list[6]:
	pass_count += 1
	atom = atom_list[6]["hdlr_0000000000008387"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stbl_0000000000008412" in atom_list[7]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stsd_000000000000841a" in atom_list[8]:
	pass_count += 1
	atom = atom_list[8]["stsd_000000000000841a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "iamf_000000000000842a" in atom_list[9]:
	pass_count += 1
	atom = atom_list[9]["iamf_000000000000842a"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "iacb_000000000000844e" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["iacb_000000000000844e"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "stts_00000000000084fd" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_00000000000084fd"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000008515" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_0000000000008515"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000008531" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_0000000000008531"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000008545" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_0000000000008545"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
if "MixPresentationOBU_3" in obu_list[3]:
		...
		if sub_mixes[0].get("audio_elements") is not None:
			...
			if audio_elements[0].get("mix_presentation_element_annotations_array") is not None:
				...
				if mix_presentation_element_annotations_array[0].get("audio_element_friendly_label") == "test_sub_mix_0_audio_element_0":
					...
					print("failure line is #%d."%(frame.f_lineno))
				no_of_check_items += 1
				if mix_presentation_element_annotations_array[1].get("audio_element_friendly_label") == "prueba_0_0":
					pass_count += 1
				else:
					frame = inspect.currentframe()
					print("failure line is #%d."%(frame.f_lineno))
	...
	if obu.get("mix_presentation_annotations_array") is not None:
		...
		if mix_presentation_annotations_array[0].get("mix_presentation_friendly_label") == "test_mix_pres":
			...
			print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if mix_presentation_annotations_array[1].get("mix_presentation_friendly_label") == "prueba_mezcla_presentación":
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
...
print("*"*40)
print("description:")
print("""A stereo IAMF stream with two language labels.""")
print("is_valid: True")
print("primary_tested_spec_sections: ['3.7/count_label', '3.7/language_label', '3.7/mix_presentation_annotations', '3.7.1/Mix Presentation Annotations Syntax and Semantics', '3.7.2/Mix Presentation Element Annotations Syntax and Semantics']")
print("*"*40)
