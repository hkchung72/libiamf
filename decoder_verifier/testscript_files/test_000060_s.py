...
no_of_check_items += 1
if "stts_000000000000856a" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_000000000000856a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000008582" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_0000000000008582"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_000000000000859e" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_000000000000859e"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000000085b2" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_00000000000085b2"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
print("is_valid: True")
print("primary_tested_spec_sections: ['2.8/count_label', '2.8/language_label', '2.8/mix_presentation_annotations']")
print("*"*40)
