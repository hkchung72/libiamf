...
parser = argparse.ArgumentParser(description="test_000301_s verification script")
...
no_of_check_items += 1
if "iacb_0000000000524a63" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["iacb_0000000000524a63"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "stts_0000000000524b32" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_0000000000524b32"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000524b4a" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_0000000000524b4a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000524b66" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_0000000000524b66"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000524b9e" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_0000000000524b9e"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
