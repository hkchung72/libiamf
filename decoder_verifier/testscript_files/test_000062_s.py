...
no_of_check_items += 1
if "stts_00000000000084cc" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["stts_00000000000084cc"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000084e4" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stsc_00000000000084e4"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000008500" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stco_0000000000008500"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000008514" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsz_0000000000008514"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
