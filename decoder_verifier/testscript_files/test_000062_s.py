...
parser = argparse.ArgumentParser(description="test_000062_s verification script")
...
no_of_check_items += 1
if "stts_00000000000084d6" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_00000000000084d6"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000084ee" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_00000000000084ee"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_000000000000850a" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_000000000000850a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_000000000000851e" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_000000000000851e"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
	...
	if obu.get("sub_mixes") is not None:
		...
		if sub_mixes[0].get("layouts") is not None:
			...
			if layouts[0].get("loudness") is not None:
				pass_count += 1
				no_of_check_items += 1
				if layouts[0]["loudness"].get("info_type") == 2:
					pass_count += 1
				else:
					frame = inspect.currentframe()
					print("failure line is #%d."%(frame.f_lineno))
				...
				if layouts[0]["loudness"].get("digital_peak") == -12879:
					...
					print("failure line is #%d."%(frame.f_lineno))
				no_of_check_items += 1
				if layouts[0]["loudness"].get("anchored_loudness") is not None:
					pass_count += 1
					no_of_check_items += 1
					if layouts[0]["loudness"]["anchored_loudness"].get("num_anchored_loudness") == 2:
						pass_count += 1
					else:
						frame = inspect.currentframe()
						print("failure line is #%d."%(frame.f_lineno))
					no_of_check_items += 1
					if layouts[0]["loudness"]["anchored_loudness"].get("anchor_elements") is not None:
						pass_count += 1
						anchor_elements = layouts[0]["loudness"]["anchored_loudness"].get("anchor_elements")
					else:
						frame = inspect.currentframe()
						print("failure line is #%d."%(frame.f_lineno))
				else:
...
print("*"*40)
print("description:")
print("""A stereo IAMF stream with anchored loudness provided with 2
different anchor elements.""")
print("is_valid: True")
print("primary_tested_spec_sections: ['3.7.7/integrated_loudness', '3.7.7/digital_peak', '3.7.7/info_type', '3.7.7/num_anchored_loudness']")
print("*"*40)
