...
no_of_check_items += 1
if "stts_00000000000084d6" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["stts_00000000000084d6"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000084ee" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stsc_00000000000084ee"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_000000000000850a" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stco_000000000000850a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_000000000000851e" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsz_000000000000851e"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
