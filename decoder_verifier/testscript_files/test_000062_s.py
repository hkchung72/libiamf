...
no_of_check_items += 1
if "moov_0000000000008304" in atom_list[1]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "mvhd_000000000000830c" in atom_list[2]:
	pass_count += 1
	atom = atom_list[2]["mvhd_000000000000830c"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trak_0000000000008378" in atom_list[3]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tkhd_0000000000008380" in atom_list[4]:
	pass_count += 1
	atom = atom_list[4]["tkhd_0000000000008380"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "mdhd_00000000000083e4" in atom_list[5]:
	pass_count += 1
	atom = atom_list[5]["mdhd_00000000000083e4"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "hdlr_0000000000008404" in atom_list[6]:
	pass_count += 1
	atom = atom_list[6]["hdlr_0000000000008404"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stbl_000000000000848f" in atom_list[7]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stsd_0000000000008497" in atom_list[8]:
	pass_count += 1
	atom = atom_list[8]["stsd_0000000000008497"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "iamf_00000000000084a7" in atom_list[9]:
	pass_count += 1
	atom = atom_list[9]["iamf_00000000000084a7"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "iamd_00000000000084cb" in atom_list[10]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stts_000000000000854f" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_000000000000854f"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000008567" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_0000000000008567"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000008583" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_0000000000008583"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000008597" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_0000000000008597"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
print("is_valid: True")
print("primary_tested_spec_sections: ['2.8.7/info_type', '2.8.7/num_anchored_loudness']")
print("*"*40)
