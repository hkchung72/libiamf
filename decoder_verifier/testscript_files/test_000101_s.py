...
parser = argparse.ArgumentParser(description="test_000101_s verification script")
...
no_of_check_items += 1
if "stts_00000000001d6d8c" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_00000000001d6d8c"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000001d6dac" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_00000000001d6dac"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000001d6dd4" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_00000000001d6dd4"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000001d6e10" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_00000000001d6e10"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
