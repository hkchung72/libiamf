...
parser = argparse.ArgumentParser(description="test_000090_s verification script")
...
no_of_check_items += 1
if "moov_0000000000009d83" in atom_list[1]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "mvhd_0000000000009d8b" in atom_list[2]:
	pass_count += 1
	atom = atom_list[2]["mvhd_0000000000009d8b"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trak_0000000000009df7" in atom_list[3]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tkhd_0000000000009dff" in atom_list[4]:
	pass_count += 1
	atom = atom_list[4]["tkhd_0000000000009dff"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "edts_0000000000009e5b" in atom_list[5]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "elst_0000000000009e63" in atom_list[6]:
	pass_count += 1
	atom = atom_list[6]["elst_0000000000009e63"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "mdhd_0000000000009e87" in atom_list[7]:
	pass_count += 1
	atom = atom_list[7]["mdhd_0000000000009e87"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "hdlr_0000000000009ea7" in atom_list[8]:
	pass_count += 1
	atom = atom_list[8]["hdlr_0000000000009ea7"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stbl_0000000000009f32" in atom_list[9]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stsd_0000000000009f3a" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["stsd_0000000000009f3a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "iamf_0000000000009f4a" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["iamf_0000000000009f4a"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "iacb_0000000000009f6e" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["iacb_0000000000009f6e"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "stts_0000000000009ffe" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stts_0000000000009ffe"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_000000000000a01e" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsc_000000000000a01e"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_000000000000a046" in atom_list[15]:
	pass_count += 1
	atom = atom_list[15]["stco_000000000000a046"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_000000000000a05e" in atom_list[16]:
	pass_count += 1
	atom = atom_list[16]["stsz_000000000000a05e"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "sgpd_000000000000a0da" in atom_list[17]:
	pass_count += 1
	atom = atom_list[17]["sgpd_000000000000a0da"]
	no_of_check_items += 1
	if atom[0]["Version"] == 1:
		pass_count += 1
	else:
