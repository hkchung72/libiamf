...
parser = argparse.ArgumentParser(description="test_000024_s verification script")
...
no_of_check_items += 1
if "moov_0000000000001b07" in atom_list[1]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "mvhd_0000000000001b0f" in atom_list[2]:
	pass_count += 1
	atom = atom_list[2]["mvhd_0000000000001b0f"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trak_0000000000001b7b" in atom_list[3]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tkhd_0000000000001b83" in atom_list[4]:
	pass_count += 1
	atom = atom_list[4]["tkhd_0000000000001b83"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "edts_0000000000001bdf" in atom_list[5]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "elst_0000000000001be7" in atom_list[6]:
	pass_count += 1
	atom = atom_list[6]["elst_0000000000001be7"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "mdhd_0000000000001c0b" in atom_list[7]:
	pass_count += 1
	atom = atom_list[7]["mdhd_0000000000001c0b"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "hdlr_0000000000001c2b" in atom_list[8]:
	pass_count += 1
	atom = atom_list[8]["hdlr_0000000000001c2b"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stbl_0000000000001cb6" in atom_list[9]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stsd_0000000000001cbe" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["stsd_0000000000001cbe"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "iamf_0000000000001cce" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["iamf_0000000000001cce"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "iacb_0000000000001cf2" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["iacb_0000000000001cf2"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "stts_0000000000001d7b" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stts_0000000000001d7b"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000001d9b" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsc_0000000000001d9b"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000001dc3" in atom_list[15]:
	pass_count += 1
	atom = atom_list[15]["stco_0000000000001dc3"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000001ddb" in atom_list[16]:
	pass_count += 1
	atom = atom_list[16]["stsz_0000000000001ddb"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
	...
	if atom[2]["SampleSize"] == 0:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[3]["SampleCount"] == 9:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if atom[4]["EntrySize_0"] == 950:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if atom[5]["EntrySize_1"] == 763:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if atom[6]["EntrySize_2"] == 742:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if atom[7]["EntrySize_3"] == 738:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "sgpd_0000000000001e13" in atom_list[17]:
	pass_count += 1
	atom = atom_list[17]["sgpd_0000000000001e13"]
	no_of_check_items += 1
	if atom[0]["Version"] == 1:
		pass_count += 1
	else:
...
print("*"*40)
print("description:")
print("""A stereo IAMF stream encoded using 60 ms Opus frames.""")
print("is_valid: True")
