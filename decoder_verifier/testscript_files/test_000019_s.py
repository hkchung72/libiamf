...
parser = argparse.ArgumentParser(description="test_000019_s verification script")
...
print("*"*40)
print("description:")
print("""A stereo IAMF stream that has two parameter blocks with the
same ID occuring one after another.""")
print("is_valid: True")
print("primary_tested_spec_sections: ['3.8/Parameter Block OBU Syntax and Semantics']")
print("*"*40)
