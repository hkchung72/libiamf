...
no_of_check_items += 1
if "stts_000000000000839c" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["stts_000000000000839c"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000083bc" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stsc_00000000000083bc"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000083d8" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stco_00000000000083d8"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000000083ec" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsz_00000000000083ec"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
