...
parser = argparse.ArgumentParser(description="test_000017_s verification script")
...
no_of_check_items += 1
if "moov_000000000000828f" in atom_list[1]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "mvhd_0000000000008297" in atom_list[2]:
	pass_count += 1
	atom = atom_list[2]["mvhd_0000000000008297"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trak_0000000000008303" in atom_list[3]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tkhd_000000000000830b" in atom_list[4]:
	pass_count += 1
	atom = atom_list[4]["tkhd_000000000000830b"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "mdhd_000000000000836f" in atom_list[5]:
	pass_count += 1
	atom = atom_list[5]["mdhd_000000000000836f"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "hdlr_000000000000838f" in atom_list[6]:
	pass_count += 1
	atom = atom_list[6]["hdlr_000000000000838f"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stbl_000000000000841a" in atom_list[7]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stsd_0000000000008422" in atom_list[8]:
	pass_count += 1
	atom = atom_list[8]["stsd_0000000000008422"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "iamf_0000000000008432" in atom_list[9]:
	pass_count += 1
	atom = atom_list[9]["iamf_0000000000008432"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "iacb_0000000000008456" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["iacb_0000000000008456"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "stts_00000000000084d7" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_00000000000084d7"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000084ef" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_00000000000084ef"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_000000000000850b" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_000000000000850b"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_000000000000851f" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_000000000000851f"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
	...
	if atom[3]["SampleCount"] == 125:
		...
		if atom[124]["EntrySize_120"] == 267:
			...
			print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if atom[125]["EntrySize_121"] == 269:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if atom[126]["EntrySize_122"] == 269:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if atom[127]["EntrySize_123"] == 269:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if atom[128]["EntrySize_124"] == 269:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		...
		if sub_mixes[0].get("layouts") is not None:
			...
			if layouts[0].get("loudness") is not None:
				...
				if layouts[0]["loudness"].get("info_type") == 0:
					...
					print("failure line is #%d."%(frame.f_lineno))
				no_of_check_items += 1
				if layouts[0]["loudness"].get("integrated_loudness") == -13743:
					pass_count += 1
				else:
					frame = inspect.currentframe()
					print("failure line is #%d."%(frame.f_lineno))
...
print("*"*40)
print("description:")
print("""A stereo IAMF stream. It is invalid because it has more than
one frame of samples trimmed off the end.""")
print("is_valid: False")
print("primary_tested_spec_sections: ['3.2/num_samples_to_trim_at_end', '3.5/num_samples_per_frame']")
print("*"*40)
