...
parser = argparse.ArgumentParser(description="test_000017 verification script")
...
if "stts_0000000000008553" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_0000000000008553"]
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
		frame = inspect.currentframe()
...
if "stsc_000000000000856b" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_000000000000856b"]
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
		frame = inspect.currentframe()
...
if "stsz_000000000000859b" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsz_000000000000859b"]
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
		frame = inspect.currentframe()
...
if "stco_0000000000008587" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stco_0000000000008587"]
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
		frame = inspect.currentframe()
...
if num_samples_to_trim_at_end == 200:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
