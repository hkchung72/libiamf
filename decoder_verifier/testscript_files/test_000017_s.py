...
no_of_check_items += 1
if "stts_00000000000084cd" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["stts_00000000000084cd"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000084e5" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stsc_00000000000084e5"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000008501" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stco_0000000000008501"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000008515" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsz_0000000000008515"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
