...
no_of_check_items += 1
if "moov_00000000000082f1" in atom_list[1]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "mvhd_00000000000082f9" in atom_list[2]:
	pass_count += 1
	atom = atom_list[2]["mvhd_00000000000082f9"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trak_0000000000008365" in atom_list[3]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tkhd_000000000000836d" in atom_list[4]:
	pass_count += 1
	atom = atom_list[4]["tkhd_000000000000836d"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "mdhd_00000000000083d1" in atom_list[5]:
	pass_count += 1
	atom = atom_list[5]["mdhd_00000000000083d1"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "hdlr_00000000000083f1" in atom_list[6]:
	pass_count += 1
	atom = atom_list[6]["hdlr_00000000000083f1"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stbl_000000000000847c" in atom_list[7]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stsd_0000000000008484" in atom_list[8]:
	pass_count += 1
	atom = atom_list[8]["stsd_0000000000008484"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "iamf_0000000000008494" in atom_list[9]:
	pass_count += 1
	atom = atom_list[9]["iamf_0000000000008494"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "iamd_00000000000084b8" in atom_list[10]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stts_0000000000008538" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_0000000000008538"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
	...
	if atom[2]["EntryCount"] == 3:
		...
		no_of_check_items += 1
		if atom[6]["SampleDelta_1"] == 56:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		stts_SampleDeltaSum += SampleCount * SampleDelta
		SampleCount = atom[7]["SampleCount_2"]
		no_of_check_items += 1
		if atom[7]["SampleCount_2"] == 1:
			...
			print("failure line is #%d."%(frame.f_lineno))
		stts_SampleCountSum += SampleCount
		SampleDelta = atom[8]["SampleDelta_2"]
		no_of_check_items += 1
		if atom[8]["SampleDelta_2"] == 63:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stsc_0000000000008560" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_0000000000008560"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
	...
	if atom[2]["EntryCount"] == 1:
		...
		if atom[3]["FirstChunk_0"] == 1:
			...
			print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if atom[4]["SamplePerChunk_0"] == 123:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stco_000000000000857c" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_000000000000857c"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000008590" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_0000000000008590"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
print("*"*40)
print("description:")
print("""A stereo IAMF stream that has more than one frame of samples
trimmed off the end.""")
print("is_valid: True")
