...
parser = argparse.ArgumentParser(description="test_000091_s verification script")
...
print("*"*40)
print("description:")
print("""A frame-aligned stereo IAMF stream encoded with AAC with an
invalid roll distance.""")
print("is_valid: False")
print("primary_tested_spec_sections: ['3.5/audio_roll_distance != -1', '3.11.2/AAC-LC Specific']")
print("*"*40)
