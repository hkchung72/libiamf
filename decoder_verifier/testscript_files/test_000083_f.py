...
no_of_check_items += 1
if "stts_0000000000000290" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["stts_0000000000000290"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000002a0" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stsc_00000000000002a0"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000002b0" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stco_00000000000002b0"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000000002c0" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsz_00000000000002c0"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "moof_0000000000000310" in atom_list[14]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "traf_0000000000000328" in atom_list[15]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tfhd_0000000000000330" in atom_list[16]:
	pass_count += 1
	atom = atom_list[16]["tfhd_0000000000000330"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
