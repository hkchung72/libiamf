...
parser = argparse.ArgumentParser(description="test_000085_s verification script")
...
print("*"*40)
print("description:")
print("""A frame-aligned LPCM stereo IAMF stream with no trimming
with an invalid roll distance.""")
print("is_valid: False")
print("primary_tested_spec_sections: ['3.2/num_samples_to_trim_at_end', '3.5/audio_roll_distance != 0', '3.11.4/LPCM Specific']")
print("*"*40)
