...
parser = argparse.ArgumentParser(description="test_000065_s verification script")
...
no_of_check_items += 1
if "moov_0000000000030e62" in atom_list[1]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "mvhd_0000000000030e6a" in atom_list[2]:
	pass_count += 1
	atom = atom_list[2]["mvhd_0000000000030e6a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trak_0000000000030ed6" in atom_list[3]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tkhd_0000000000030ede" in atom_list[4]:
	pass_count += 1
	atom = atom_list[4]["tkhd_0000000000030ede"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "mdhd_0000000000030f42" in atom_list[5]:
	pass_count += 1
	atom = atom_list[5]["mdhd_0000000000030f42"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "hdlr_0000000000030f62" in atom_list[6]:
	pass_count += 1
	atom = atom_list[6]["hdlr_0000000000030f62"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stbl_0000000000030fed" in atom_list[7]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stsd_0000000000030ff5" in atom_list[8]:
	pass_count += 1
	atom = atom_list[8]["stsd_0000000000030ff5"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "iamf_0000000000031005" in atom_list[9]:
	pass_count += 1
	atom = atom_list[9]["iamf_0000000000031005"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "iacb_0000000000031029" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["iacb_0000000000031029"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "stts_00000000000310b4" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_00000000000310b4"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000310cc" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_00000000000310cc"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000310e8" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_00000000000310e8"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000000310fc" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_00000000000310fc"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
		...
		if sub_mixes[0].get("layouts") is not None:
			...
			if layouts[0].get("loudness") is not None:
				...
				if layouts[0]["loudness"].get("info_type") == 0:
					...
					print("failure line is #%d."%(frame.f_lineno))
				no_of_check_items += 1
				if layouts[0]["loudness"].get("integrated_loudness") == -4809:
					pass_count += 1
				else:
					frame = inspect.currentframe()
					print("failure line is #%d."%(frame.f_lineno))
				no_of_check_items += 1
				if layouts[0]["loudness"].get("digital_peak") == -3347:
					pass_count += 1
				else:
					frame = inspect.currentframe()
					print("failure line is #%d."%(frame.f_lineno))
...
mix gain.""")
print("is_valid: True")
print("primary_tested_spec_sections: ['3.6.3/ambisonics_mono_config', '3.8.1/animation_type == LINEAR', '7/IAMF Processing', '7.4/animation_type == LINEAR']")
print("*"*40)
