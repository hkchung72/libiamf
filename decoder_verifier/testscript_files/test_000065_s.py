...
no_of_check_items += 1
if "stts_00000000000310a9" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["stts_00000000000310a9"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000310c1" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stsc_00000000000310c1"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000310dd" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stco_00000000000310dd"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000000310f1" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsz_00000000000310f1"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
