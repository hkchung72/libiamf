...
no_of_check_items += 1
if "stts_00000000001d682c" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["stts_00000000001d682c"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000001d684c" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stsc_00000000001d684c"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000001d6874" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stco_00000000001d6874"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000001d68b0" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsz_00000000001d68b0"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
