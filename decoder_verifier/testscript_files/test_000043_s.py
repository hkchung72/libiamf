...
no_of_check_items += 1
if "moov_00000000000c0a30" in atom_list[1]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "mvhd_00000000000c0a38" in atom_list[2]:
	pass_count += 1
	atom = atom_list[2]["mvhd_00000000000c0a38"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trak_00000000000c0aa4" in atom_list[3]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tkhd_00000000000c0aac" in atom_list[4]:
	pass_count += 1
	atom = atom_list[4]["tkhd_00000000000c0aac"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "mdhd_00000000000c0b10" in atom_list[5]:
	pass_count += 1
	atom = atom_list[5]["mdhd_00000000000c0b10"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "hdlr_00000000000c0b30" in atom_list[6]:
	pass_count += 1
	atom = atom_list[6]["hdlr_00000000000c0b30"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stbl_00000000000c0bbb" in atom_list[7]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stsd_00000000000c0bc3" in atom_list[8]:
	pass_count += 1
	atom = atom_list[8]["stsd_00000000000c0bc3"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "iamf_00000000000c0bd3" in atom_list[9]:
	pass_count += 1
	atom = atom_list[9]["iamf_00000000000c0bd3"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "iacb_00000000000c0bf7" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["iacb_00000000000c0bf7"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "stts_00000000000c0e8b" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_00000000000c0e8b"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000c0ea3" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_00000000000c0ea3"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000c0ebf" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_00000000000c0ebf"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000000c0ed3" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_00000000000c0ed3"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
demixing matrix.""")
print("is_valid: True")
print("primary_tested_spec_sections: ['3.6.3/ambisonics_projection_config', '7/IAMF Processing', '7.1/demixing_matrix', '7.3.2/Rendering an Audio Element', '7.3.2.2/Rendering a Scene-Based Audio Element to Loudspeakers']")
print("*"*40)
