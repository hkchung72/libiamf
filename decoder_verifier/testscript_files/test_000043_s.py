...
no_of_check_items += 1
if "stts_00000000000c0e80" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["stts_00000000000c0e80"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000c0e98" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stsc_00000000000c0e98"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000c0eb4" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stco_00000000000c0eb4"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000000c0ec8" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsz_00000000000c0ec8"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
