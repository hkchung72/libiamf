...
no_of_check_items += 1
if "stts_00000000000c0ffd" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_00000000000c0ffd"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000c1015" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_00000000000c1015"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000c1031" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_00000000000c1031"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000000c1045" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_00000000000c1045"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
