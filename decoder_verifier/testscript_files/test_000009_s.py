...
parser = argparse.ArgumentParser(description="test_000009_s verification script")
...
no_of_check_items += 1
if "moov_00000000000082fb" in atom_list[1]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "mvhd_0000000000008303" in atom_list[2]:
	pass_count += 1
	atom = atom_list[2]["mvhd_0000000000008303"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trak_000000000000836f" in atom_list[3]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tkhd_0000000000008377" in atom_list[4]:
	pass_count += 1
	atom = atom_list[4]["tkhd_0000000000008377"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "mdhd_00000000000083db" in atom_list[5]:
	pass_count += 1
	atom = atom_list[5]["mdhd_00000000000083db"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "hdlr_00000000000083fb" in atom_list[6]:
	pass_count += 1
	atom = atom_list[6]["hdlr_00000000000083fb"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stbl_0000000000008486" in atom_list[7]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stsd_000000000000848e" in atom_list[8]:
	pass_count += 1
	atom = atom_list[8]["stsd_000000000000848e"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "iamf_000000000000849e" in atom_list[9]:
	pass_count += 1
	atom = atom_list[9]["iamf_000000000000849e"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "iamd_00000000000084c2" in atom_list[10]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stts_0000000000008543" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_0000000000008543"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_000000000000855b" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_000000000000855b"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000008577" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_0000000000008577"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_000000000000858b" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_000000000000858b"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
with the audio frames, starting 100 samples later. This is
