...
parser = argparse.ArgumentParser(description="test_000208_s verification script")
...
no_of_check_items += 1
if "stts_00000000005835de" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_00000000005835de"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000005835fe" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_00000000005835fe"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000583626" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_0000000000583626"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000583662" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_0000000000583662"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
