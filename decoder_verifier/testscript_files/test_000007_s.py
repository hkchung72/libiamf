...
parser = argparse.ArgumentParser(description="test_000007_s verification script")
...
print("*"*40)
print("description:")
print("""A stereo IAMF stream with which is invalid because `ia_code`
is case-sensitive and should be lowercase.""")
print("is_valid: False")
print("primary_tested_spec_sections: ['3.4/ia_code']")
print("*"*40)
