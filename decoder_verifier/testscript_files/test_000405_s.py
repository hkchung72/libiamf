...
no_of_check_items += 1
if "moov_0000000000039a01" in atom_list[0]:
	pass_count += 1
else:
...
no_of_check_items += 1
if "mvhd_0000000000039a09" in atom_list[1]:
	pass_count += 1
	atom = atom_list[1]["mvhd_0000000000039a09"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trak_0000000000039a75" in atom_list[2]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tkhd_0000000000039a7d" in atom_list[3]:
	pass_count += 1
	atom = atom_list[3]["tkhd_0000000000039a7d"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "edts_0000000000039ad9" in atom_list[4]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "elst_0000000000039ae1" in atom_list[5]:
	pass_count += 1
	atom = atom_list[5]["elst_0000000000039ae1"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "mdhd_0000000000039b05" in atom_list[6]:
	pass_count += 1
	atom = atom_list[6]["mdhd_0000000000039b05"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "hdlr_0000000000039b25" in atom_list[7]:
	pass_count += 1
	atom = atom_list[7]["hdlr_0000000000039b25"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stbl_0000000000039bb0" in atom_list[8]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stsd_0000000000039bb8" in atom_list[9]:
	pass_count += 1
	atom = atom_list[9]["stsd_0000000000039bb8"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "iamf_0000000000039bc8" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["iamf_0000000000039bc8"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "iacb_0000000000039bec" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["iacb_0000000000039bec"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "stts_0000000000039cbb" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stts_0000000000039cbb"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000039cdb" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsc_0000000000039cdb"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000039d03" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stco_0000000000039d03"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000039d3f" in atom_list[15]:
	pass_count += 1
	atom = atom_list[15]["stsz_0000000000039d3f"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "sgpd_000000000003a13f" in atom_list[16]:
	pass_count += 1
	atom = atom_list[16]["sgpd_000000000003a13f"]
	no_of_check_items += 1
	if atom[0]["Version"] == 1:
		pass_count += 1
	else:
