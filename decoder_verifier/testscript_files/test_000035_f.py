...
parser = argparse.ArgumentParser(description="test_000035_f verification script")
...
no_of_check_items += 1
if "stts_00000000000002af" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stts_00000000000002af"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000002bf" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsc_00000000000002bf"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000002cf" in atom_list[15]:
	pass_count += 1
	atom = atom_list[15]["stco_00000000000002cf"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000000002df" in atom_list[16]:
	pass_count += 1
	atom = atom_list[16]["stsz_00000000000002df"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "moof_000000000000032f" in atom_list[17]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "traf_0000000000000347" in atom_list[18]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tfhd_000000000000034f" in atom_list[19]:
	pass_count += 1
	atom = atom_list[19]["tfhd_000000000000034f"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trun_0000000000000377" in atom_list[20]:
	pass_count += 1
	atom = atom_list[20]["trun_0000000000000377"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
	...
	if atom[4]["SampleDuration_0"] == 960:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[5]["SampleSize_0"] == 189:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[6]["SampleCompositionTimeOffset_0"] == 120:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[7]["SampleDuration_1"] == 960:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[8]["SampleSize_1"] == 168:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[9]["SampleCompositionTimeOffset_1"] == 120:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[10]["SampleDuration_2"] == 960:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[11]["SampleSize_2"] == 159:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[12]["SampleCompositionTimeOffset_2"] == 120:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[13]["SampleDuration_3"] == 960:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[14]["SampleSize_3"] == 146:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[15]["SampleCompositionTimeOffset_3"] == 120:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[16]["SampleDuration_4"] == 960:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[17]["SampleSize_4"] == 134:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[18]["SampleCompositionTimeOffset_4"] == 120:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[19]["SampleDuration_5"] == 960:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[20]["SampleSize_5"] == 134:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[21]["SampleCompositionTimeOffset_5"] == 120:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[22]["SampleDuration_6"] == 960:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[23]["SampleSize_6"] == 134:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[24]["SampleCompositionTimeOffset_6"] == 120:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[25]["SampleDuration_7"] == 960:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[26]["SampleSize_7"] == 134:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[27]["SampleCompositionTimeOffset_7"] == 120:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[28]["SampleDuration_8"] == 960:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[29]["SampleSize_8"] == 134:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[30]["SampleCompositionTimeOffset_8"] == 120:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[31]["SampleDuration_9"] == 960:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[32]["SampleSize_9"] == 134:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[33]["SampleCompositionTimeOffset_9"] == 120:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[34]["SampleDuration_10"] == 960:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[35]["SampleSize_10"] == 134:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[36]["SampleCompositionTimeOffset_10"] == 120:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[37]["SampleDuration_11"] == 960:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[38]["SampleSize_11"] == 134:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[39]["SampleCompositionTimeOffset_11"] == 120:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[40]["SampleDuration_12"] == 960:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[41]["SampleSize_12"] == 134:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[42]["SampleCompositionTimeOffset_12"] == 120:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[43]["SampleDuration_13"] == 960:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[44]["SampleSize_13"] == 134:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[45]["SampleCompositionTimeOffset_13"] == 120:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[46]["SampleDuration_14"] == 960:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[47]["SampleSize_14"] == 134:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[48]["SampleCompositionTimeOffset_14"] == 120:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[49]["SampleDuration_15"] == 960:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[50]["SampleSize_15"] == 134:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[51]["SampleCompositionTimeOffset_15"] == 120:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[52]["SampleDuration_16"] == 960:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[53]["SampleSize_16"] == 134:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[54]["SampleCompositionTimeOffset_16"] == 120:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[55]["SampleDuration_17"] == 960:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[56]["SampleSize_17"] == 134:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[57]["SampleCompositionTimeOffset_17"] == 120:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[58]["SampleDuration_18"] == 960:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[59]["SampleSize_18"] == 134:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[60]["SampleCompositionTimeOffset_18"] == 120:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[61]["SampleDuration_19"] == 960:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[62]["SampleSize_19"] == 134:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[63]["SampleCompositionTimeOffset_19"] == 120:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[64]["SampleDuration_20"] == 960:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[65]["SampleSize_20"] == 134:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[66]["SampleCompositionTimeOffset_20"] == 120:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[67]["SampleDuration_21"] == 960:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[68]["SampleSize_21"] == 134:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[69]["SampleCompositionTimeOffset_21"] == 120:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[70]["SampleDuration_22"] == 960:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[71]["SampleSize_22"] == 134:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[72]["SampleCompositionTimeOffset_22"] == 120:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[73]["SampleDuration_23"] == 960:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[74]["SampleSize_23"] == 134:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[75]["SampleCompositionTimeOffset_23"] == 120:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[76]["SampleDuration_24"] == 960:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[77]["SampleSize_24"] == 134:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[78]["SampleCompositionTimeOffset_24"] == 120:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[79]["SampleDuration_25"] == 120:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[80]["SampleSize_25"] == 135:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[81]["SampleCompositionTimeOffset_25"] == 120:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if obu.get("codec_config") is not None:
		...
		if obu["codec_config"].get("decoder_config_opus") is not None:
			...
			if obu["codec_config"]["decoder_config_opus"].get("output_channel_count") == 2:
				...
				print("failure line is #%d."%(frame.f_lineno))
			no_of_check_items += 1
			if obu["codec_config"]["decoder_config_opus"].get("pre_skip") == 120:
				pass_count += 1
			else:
				frame = inspect.currentframe()
				print("failure line is #%d."%(frame.f_lineno))
		...
		if sub_mixes[0].get("layouts") is not None:
			...
			if layouts[0].get("loudness") is not None:
				...
				if layouts[0]["loudness"].get("info_type") == 0:
					...
					print("failure line is #%d."%(frame.f_lineno))
				no_of_check_items += 1
				if layouts[0]["loudness"].get("integrated_loudness") == -3143:
					pass_count += 1
				else:
					frame = inspect.currentframe()
					print("failure line is #%d."%(frame.f_lineno))
				no_of_check_items += 1
				if layouts[0]["loudness"].get("digital_peak") == -1731:
					pass_count += 1
				else:
					frame = inspect.currentframe()
					print("failure line is #%d."%(frame.f_lineno))
...
print("*"*40)
print("description:")
print("""A stereo IAMF stream encoded using low-delay mode for
libopus.""")
print("is_valid: True")
print("primary_tested_spec_sections: ['3.10', '3.13.1']")
print("*"*40)
