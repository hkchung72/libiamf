...
no_of_check_items += 1
if "stts_0000000000001d54" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stts_0000000000001d54"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000001d74" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsc_0000000000001d74"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000001d9c" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stco_0000000000001d9c"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000001db4" in atom_list[15]:
	pass_count += 1
	atom = atom_list[15]["stsz_0000000000001db4"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "sgpd_0000000000001e30" in atom_list[16]:
	pass_count += 1
	atom = atom_list[16]["sgpd_0000000000001e30"]
	no_of_check_items += 1
	if atom[0]["Version"] == 1:
		pass_count += 1
	else:
