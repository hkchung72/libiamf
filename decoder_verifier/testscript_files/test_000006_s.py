...
parser = argparse.ArgumentParser(description="test_000006 verification script")
...
if "stsz_0000000000008593" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsz_0000000000008593"]
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
		frame = inspect.currentframe()
...
if "stco_000000000000857f" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stco_000000000000857f"]
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
		frame = inspect.currentframe()
