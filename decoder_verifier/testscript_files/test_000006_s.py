...
parser = argparse.ArgumentParser(description="test_000006_s verification script")
...
no_of_check_items += 1
if "stts_00000000000084cf" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_00000000000084cf"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000084e7" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_00000000000084e7"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000008503" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_0000000000008503"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000008517" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_0000000000008517"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
print("*"*40)
print("description:")
print("""A stereo base profile IAMF stream with temporal delimiters.""")
print("is_valid: True")
print("primary_tested_spec_sections: ['3.4/IA Sequence Header OBU Syntax and Semantics', '3.10/Codec Specific', '4.2/temporal_delimiter_obu', '5.1/IA Sequence', '5.1.2/IA Data OBUs', '6.2.4/temporal_delimiter_obu']")
print("*"*40)
