...
no_of_check_items += 1
if "stts_000000000000812e" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["stts_000000000000812e"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_000000000000814e" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stsc_000000000000814e"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_000000000000816a" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stco_000000000000816a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_000000000000817e" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsz_000000000000817e"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
