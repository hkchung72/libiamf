...
parser = argparse.ArgumentParser(description="test_000079_s verification script")
...
no_of_check_items += 1
if "moov_0000000000007ee7" in atom_list[1]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "mvhd_0000000000007eef" in atom_list[2]:
	pass_count += 1
	atom = atom_list[2]["mvhd_0000000000007eef"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trak_0000000000007f5b" in atom_list[3]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tkhd_0000000000007f63" in atom_list[4]:
	pass_count += 1
	atom = atom_list[4]["tkhd_0000000000007f63"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "mdhd_0000000000007fc7" in atom_list[5]:
	pass_count += 1
	atom = atom_list[5]["mdhd_0000000000007fc7"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "hdlr_0000000000007fe7" in atom_list[6]:
	pass_count += 1
	atom = atom_list[6]["hdlr_0000000000007fe7"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stbl_0000000000008072" in atom_list[7]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stsd_000000000000807a" in atom_list[8]:
	pass_count += 1
	atom = atom_list[8]["stsd_000000000000807a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "iamf_000000000000808a" in atom_list[9]:
	pass_count += 1
	atom = atom_list[9]["iamf_000000000000808a"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "iacb_00000000000080ae" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["iacb_00000000000080ae"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "stts_0000000000008139" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_0000000000008139"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000008159" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_0000000000008159"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000008175" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_0000000000008175"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000008189" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_0000000000008189"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
pass_count = 0
no_of_check_items += 1
if "IaSequenceHeaderOBU_1" in obu_list[1]:
	pass_count += 1
	obu = obu_list[1].get("IaSequenceHeaderOBU_1")[0]
	no_of_check_items += 1
	...
	print("failure line is #%d."%(frame.f_lineno))
no_of_check_items += 1
if "CodecConfigOBU_2" in obu_list[2]:
	pass_count += 1
	obu = obu_list[2].get("CodecConfigOBU_2")[0]
	no_of_check_items += 1
...
print("*"*40)
print("description:")
print("""A simple example of a stereo IAMF stream with an extra
redundant sequence header inserted before the initial
descriptor OBUs.""")
print("is_valid: True")
print("primary_tested_spec_sections: ['3.2/obu_redundant_copy']")
print("*"*40)
