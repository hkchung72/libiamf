...
parser = argparse.ArgumentParser(description="test_000220_s verification script")
...
no_of_check_items += 1
if "stts_0000000000057cea" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stts_0000000000057cea"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000057d0a" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsc_0000000000057d0a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000057d32" in atom_list[15]:
	pass_count += 1
	atom = atom_list[15]["stco_0000000000057d32"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000057d6e" in atom_list[16]:
	pass_count += 1
	atom = atom_list[16]["stsz_0000000000057d6e"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "sgpd_000000000005816e" in atom_list[17]:
	pass_count += 1
	atom = atom_list[17]["sgpd_000000000005816e"]
	no_of_check_items += 1
	if atom[0]["Version"] == 1:
		pass_count += 1
	else:
