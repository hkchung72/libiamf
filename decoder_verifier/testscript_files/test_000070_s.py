...
parser = argparse.ArgumentParser(description="test_000070_s verification script")
...
no_of_check_items += 1
if "stts_00000000005835f1" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_00000000005835f1"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000583611" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_0000000000583611"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000583639" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_0000000000583639"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000583675" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_0000000000583675"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
