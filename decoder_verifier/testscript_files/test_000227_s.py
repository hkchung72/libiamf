...
parser = argparse.ArgumentParser(description="test_000227_s verification script")
...
no_of_check_items += 1
if "moov_0000000000077b2a" in atom_list[1]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "mvhd_0000000000077b32" in atom_list[2]:
	pass_count += 1
	atom = atom_list[2]["mvhd_0000000000077b32"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trak_0000000000077b9e" in atom_list[3]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tkhd_0000000000077ba6" in atom_list[4]:
	pass_count += 1
	atom = atom_list[4]["tkhd_0000000000077ba6"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "edts_0000000000077c02" in atom_list[5]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "elst_0000000000077c0a" in atom_list[6]:
	pass_count += 1
	atom = atom_list[6]["elst_0000000000077c0a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "mdhd_0000000000077c2e" in atom_list[7]:
	pass_count += 1
	atom = atom_list[7]["mdhd_0000000000077c2e"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "hdlr_0000000000077c4e" in atom_list[8]:
	pass_count += 1
	atom = atom_list[8]["hdlr_0000000000077c4e"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stbl_0000000000077cd9" in atom_list[9]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stsd_0000000000077ce1" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["stsd_0000000000077ce1"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "iamf_0000000000077cf1" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["iamf_0000000000077cf1"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "iacb_0000000000077d15" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["iacb_0000000000077d15"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "stts_0000000000077dd1" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stts_0000000000077dd1"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000077df1" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsc_0000000000077df1"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000077e19" in atom_list[15]:
	pass_count += 1
	atom = atom_list[15]["stco_0000000000077e19"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
	...
	if atom[2]["EntryCount"] == 11:
		...
		if atom[4]["ChunkOffset_1"] == 50268:
			...
			print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if atom[5]["ChunkOffset_2"] == 97567:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if atom[6]["ChunkOffset_3"] == 146463:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		...
		if atom[10]["ChunkOffset_7"] == 341000:
			...
			print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if atom[11]["ChunkOffset_8"] == 390036:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if atom[12]["ChunkOffset_9"] == 438742:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if atom[13]["ChunkOffset_10"] == 487125:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stsz_0000000000077e55" in atom_list[16]:
	pass_count += 1
	atom = atom_list[16]["stsz_0000000000077e55"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
	...
	if atom[3]["SampleCount"] == 251:
		...
		if atom[191]["EntrySize_187"] == 1869:
			...
			print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if atom[192]["EntrySize_188"] == 1900:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "sgpd_0000000000078255" in atom_list[17]:
	pass_count += 1
	atom = atom_list[17]["sgpd_0000000000078255"]
	no_of_check_items += 1
	if atom[0]["Version"] == 1:
		pass_count += 1
	else:
