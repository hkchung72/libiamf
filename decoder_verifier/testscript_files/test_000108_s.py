...
parser = argparse.ArgumentParser(description="test_000108_s verification script")
...
no_of_check_items += 1
if "stts_000000000000772e" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stts_000000000000772e"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_000000000000774e" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsc_000000000000774e"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000007776" in atom_list[15]:
	pass_count += 1
	atom = atom_list[15]["stco_0000000000007776"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000000077b2" in atom_list[16]:
	pass_count += 1
	atom = atom_list[16]["stsz_00000000000077b2"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "sgpd_0000000000007bb2" in atom_list[17]:
	pass_count += 1
	atom = atom_list[17]["sgpd_0000000000007bb2"]
	no_of_check_items += 1
	if atom[0]["Version"] == 1:
		pass_count += 1
	else:
