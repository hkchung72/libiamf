...
parser = argparse.ArgumentParser(description="test_000001 verification script")
...
if "stco_00000000000002a9" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stco_00000000000002a9"]
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
		frame = inspect.currentframe()
...
if "moof_00000000000002dd" in atom_list[15]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))

if "traf_00000000000002f5" in atom_list[16]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))

if "tfhd_00000000000002fd" in atom_list[17]:
	pass_count += 1
	atom = atom_list[17]["tfhd_00000000000002fd"]
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
		frame = inspect.currentframe()
...
if "trun_0000000000000325" in atom_list[18]:
	pass_count += 1
	atom = atom_list[18]["trun_0000000000000325"]
	if atom[0]["Version"] == 1:
		pass_count += 1
	else:
		frame = inspect.currentframe()
