...
parser = argparse.ArgumentParser(description="test_000040_s verification script")
...
no_of_check_items += 1
if "moov_0000000000024d06" in atom_list[1]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "mvhd_0000000000024d0e" in atom_list[2]:
	pass_count += 1
	atom = atom_list[2]["mvhd_0000000000024d0e"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trak_0000000000024d7a" in atom_list[3]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tkhd_0000000000024d82" in atom_list[4]:
	pass_count += 1
	atom = atom_list[4]["tkhd_0000000000024d82"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "mdhd_0000000000024de6" in atom_list[5]:
	pass_count += 1
	atom = atom_list[5]["mdhd_0000000000024de6"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "hdlr_0000000000024e06" in atom_list[6]:
	pass_count += 1
	atom = atom_list[6]["hdlr_0000000000024e06"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stbl_0000000000024e91" in atom_list[7]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stsd_0000000000024e99" in atom_list[8]:
	pass_count += 1
	atom = atom_list[8]["stsd_0000000000024e99"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "iamf_0000000000024ea9" in atom_list[9]:
	pass_count += 1
	atom = atom_list[9]["iamf_0000000000024ea9"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "iamd_0000000000024ecd" in atom_list[10]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stts_0000000000024f59" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_0000000000024f59"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000024f71" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_0000000000024f71"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000024f8d" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_0000000000024f8d"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000024fa1" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_0000000000024fa1"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
if "AudioElementOBU_2" in obu_list[2]:
	...
	if obu.get("ambisonics_config") is not None:
		...
		if obu["ambisonics_config"].get("ambisonics_mono_config") is not None:
			pass_count += 1
			no_of_check_items += 1
			if obu["ambisonics_config"]["ambisonics_mono_config"].get("output_channel_count") == 3:
				pass_count += 1
			else:
				frame = inspect.currentframe()
				print("failure line is #%d."%(frame.f_lineno))
			no_of_check_items += 1
			if obu["ambisonics_config"]["ambisonics_mono_config"].get("substream_count") == 3:
				pass_count += 1
			else:
				frame = inspect.currentframe()
				print("failure line is #%d."%(frame.f_lineno))
		...
		if sub_mixes[0].get("layouts") is not None:
			...
			if layouts[0].get("loudness") is not None:
				...
				if layouts[0]["loudness"].get("info_type") == 0:
					...
					print("failure line is #%d."%(frame.f_lineno))
				no_of_check_items += 1
				if layouts[0]["loudness"].get("integrated_loudness") == -5474:
					pass_count += 1
				else:
					frame = inspect.currentframe()
					print("failure line is #%d."%(frame.f_lineno))
				no_of_check_items += 1
				if layouts[0]["loudness"].get("digital_peak") == -4454:
					pass_count += 1
				else:
					frame = inspect.currentframe()
					print("failure line is #%d."%(frame.f_lineno))
...
if "SyncOBU_4" in obu_list[4]:
	...
	if obu.get("sync_array") is not None:
		...
		if sync_array[2].get("relative_offset") == 0:
			...
			print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if sync_array[3].get("obu_id") == 100:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if sync_array[3].get("obu_data_type") == 1: # OBU_DATA_TYPE_PARAMETER
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
