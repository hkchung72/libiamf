...
no_of_check_items += 1
if "stts_00000000000002b9" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_00000000000002b9"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000002c9" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_00000000000002c9"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000002d9" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_00000000000002d9"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000000002e9" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_00000000000002e9"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "moof_0000000000000339" in atom_list[15]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "traf_0000000000000351" in atom_list[16]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tfhd_0000000000000359" in atom_list[17]:
	pass_count += 1
	atom = atom_list[17]["tfhd_0000000000000359"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
	...
	if atom[4]["DefaultSampleDuration"] == 64:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[5]["DefaultSampleSize"] == 527:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "trun_0000000000000389" in atom_list[18]:
	pass_count += 1
	atom = atom_list[18]["trun_0000000000000389"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
