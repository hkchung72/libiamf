...
parser = argparse.ArgumentParser(description="test_000041_s verification script")
...
no_of_check_items += 1
if "stts_000000000000854e" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_000000000000854e"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000008566" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_0000000000008566"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000008582" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_0000000000008582"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000008596" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_0000000000008596"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
if "SyncOBU_4" in obu_list[4]:
	...
	if obu.get("sync_array") is not None:
		...
		if sync_array[1].get("relative_offset") == 0:
			...
			print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if sync_array[2].get("obu_id") == 101:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
...
print("*"*40)
print("description:")
print("""A stereo IAMF stream with an extra unused obu ID in the Sync
OBU.""")
print("is_valid: False")
print("primary_tested_spec_sections: ['3.12']")
print("*"*40)
