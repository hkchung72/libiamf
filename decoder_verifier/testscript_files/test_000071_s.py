...
no_of_check_items += 1
if "stts_0000000000008311" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["stts_0000000000008311"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000008329" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stsc_0000000000008329"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000008351" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stco_0000000000008351"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000008369" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsz_0000000000008369"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
