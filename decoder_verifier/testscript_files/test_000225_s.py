...
parser = argparse.ArgumentParser(description="test_000225_s verification script")
...
no_of_check_items += 1
if "iacb_000000000058354b" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["iacb_000000000058354b"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "stts_0000000000583606" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_0000000000583606"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000583626" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_0000000000583626"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_000000000058364e" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_000000000058364e"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_000000000058368a" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_000000000058368a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
