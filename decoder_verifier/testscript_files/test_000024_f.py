...
parser = argparse.ArgumentParser(description="test_000024_f verification script")
...
if "trun_000000000000037c" in atom_list[20]:
	...
	if atom[18]["SampleDuration_7"] == 2880:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[19]["SampleSize_7"] == 732:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[20]["SampleDuration_8"] == 1272:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
