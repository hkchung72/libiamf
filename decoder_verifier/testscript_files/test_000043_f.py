...
parser = argparse.ArgumentParser(description="test_000043_f verification script")
...
no_of_check_items += 1
if "stts_00000000000004c6" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_00000000000004c6"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000004d6" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_00000000000004d6"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000004e6" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_00000000000004e6"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000000004f6" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_00000000000004f6"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "moof_0000000000000546" in atom_list[15]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "traf_000000000000055e" in atom_list[16]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tfhd_0000000000000566" in atom_list[17]:
	pass_count += 1
	atom = atom_list[17]["tfhd_0000000000000566"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
	...
	if atom[4]["DefaultSampleDuration"] == 64:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[5]["DefaultSampleSize"] == 2105:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "trun_0000000000000596" in atom_list[18]:
	pass_count += 1
	atom = atom_list[18]["trun_0000000000000596"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
