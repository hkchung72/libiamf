...
if "iamf_0000000000000ff2" in atom_list[11]:
	...
	if atom[12]["num_samples_per_frame"] == 960:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[13]["audio_roll_distance"] == -5:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stts_0000000000001095" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stts_0000000000001095"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000010b5" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsc_00000000000010b5"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000010dd" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stco_00000000000010dd"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000000010f5" in atom_list[15]:
	pass_count += 1
	atom = atom_list[15]["stsz_00000000000010f5"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "sgpd_0000000000001171" in atom_list[16]:
	pass_count += 1
	atom = atom_list[16]["sgpd_0000000000001171"]
	no_of_check_items += 1
	if atom[0]["Version"] == 1:
		pass_count += 1
	else:
