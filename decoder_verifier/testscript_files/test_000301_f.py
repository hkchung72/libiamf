...
no_of_check_items += 1
if "stts_00000000000002cf" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_00000000000002cf"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000002df" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_00000000000002df"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000002ef" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_00000000000002ef"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000000002ff" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_00000000000002ff"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "moof_000000000000034f" in atom_list[15]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "traf_0000000000000367" in atom_list[16]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tfhd_000000000000036f" in atom_list[17]:
	pass_count += 1
	atom = atom_list[17]["tfhd_000000000000036f"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
	...
	if atom[4]["DefaultSampleDuration"] == 64:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[5]["DefaultSampleSize"] == 1438:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "trun_000000000000039f" in atom_list[18]:
	pass_count += 1
	atom = atom_list[18]["trun_000000000000039f"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
