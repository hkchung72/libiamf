...
parser = argparse.ArgumentParser(description="test_000110_s verification script")
...
no_of_check_items += 1
if "stts_00000000000416ec" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stts_00000000000416ec"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_000000000004170c" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsc_000000000004170c"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000041734" in atom_list[15]:
	pass_count += 1
	atom = atom_list[15]["stco_0000000000041734"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000041770" in atom_list[16]:
	pass_count += 1
	atom = atom_list[16]["stsz_0000000000041770"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "sgpd_0000000000041b70" in atom_list[17]:
	pass_count += 1
	atom = atom_list[17]["sgpd_0000000000041b70"]
	no_of_check_items += 1
	if atom[0]["Version"] == 1:
		pass_count += 1
	else:
