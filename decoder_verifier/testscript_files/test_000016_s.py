...
parser = argparse.ArgumentParser(description="test_000016 verification script")
...
if "stsz_0000000000008682" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsz_0000000000008682"]
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
		frame = inspect.currentframe()
...
if "stco_000000000000866e" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stco_000000000000866e"]
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
		frame = inspect.currentframe()
