...
parser = argparse.ArgumentParser(description="test_000016_s verification script")
...
no_of_check_items += 1
if "moov_000000000000833d" in atom_list[1]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "mvhd_0000000000008345" in atom_list[2]:
	pass_count += 1
	atom = atom_list[2]["mvhd_0000000000008345"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trak_00000000000083b1" in atom_list[3]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tkhd_00000000000083b9" in atom_list[4]:
	pass_count += 1
	atom = atom_list[4]["tkhd_00000000000083b9"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "mdhd_000000000000841d" in atom_list[5]:
	pass_count += 1
	atom = atom_list[5]["mdhd_000000000000841d"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "hdlr_000000000000843d" in atom_list[6]:
	pass_count += 1
	atom = atom_list[6]["hdlr_000000000000843d"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stbl_00000000000084c8" in atom_list[7]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stsd_00000000000084d0" in atom_list[8]:
	pass_count += 1
	atom = atom_list[8]["stsd_00000000000084d0"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "iamf_00000000000084e0" in atom_list[9]:
	pass_count += 1
	atom = atom_list[9]["iamf_00000000000084e0"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "iacb_0000000000008504" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["iacb_0000000000008504"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "stts_0000000000008585" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_0000000000008585"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_000000000000859d" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_000000000000859d"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000085b9" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_00000000000085b9"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000000085cd" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_00000000000085cd"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
print("*"*40)
print("description:")
print("""A stereo IAMF stream. It has a parameter block not aligned
...
print("primary_tested_spec_sections: ['3.5/num_samples_per_frame', '3.6.1/param_definition_mode', '3.8/duration', '3.8/constant_subblock_duration', '3.9/Audio Frame OBU Syntax and Semantics']")
print("*"*40)
