...
no_of_check_items += 1
if "stts_0000000000008637" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_0000000000008637"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_000000000000864f" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_000000000000864f"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_000000000000866b" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_000000000000866b"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_000000000000867f" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_000000000000867f"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
