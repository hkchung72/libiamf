...
parser = argparse.ArgumentParser(description="test_000096_s verification script")
...
no_of_check_items += 1
if "stts_000000000075aeda" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_000000000075aeda"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_000000000075aefa" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_000000000075aefa"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_000000000075af22" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_000000000075af22"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_000000000075af5e" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_000000000075af5e"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
