...
parser = argparse.ArgumentParser(description="test_000029_s verification script")
...
no_of_check_items += 1
if "moov_0000000000018745" in atom_list[1]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "mvhd_000000000001874d" in atom_list[2]:
	pass_count += 1
	atom = atom_list[2]["mvhd_000000000001874d"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trak_00000000000187b9" in atom_list[3]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tkhd_00000000000187c1" in atom_list[4]:
	pass_count += 1
	atom = atom_list[4]["tkhd_00000000000187c1"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "mdhd_0000000000018825" in atom_list[5]:
	pass_count += 1
	atom = atom_list[5]["mdhd_0000000000018825"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "hdlr_0000000000018845" in atom_list[6]:
	pass_count += 1
	atom = atom_list[6]["hdlr_0000000000018845"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stbl_00000000000188d0" in atom_list[7]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stsd_00000000000188d8" in atom_list[8]:
	pass_count += 1
	atom = atom_list[8]["stsd_00000000000188d8"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "iamf_00000000000188e8" in atom_list[9]:
	pass_count += 1
	atom = atom_list[9]["iamf_00000000000188e8"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "iacb_000000000001890c" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["iacb_000000000001890c"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "stts_000000000001898f" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_000000000001898f"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000189a7" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_00000000000189a7"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000189c3" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_00000000000189c3"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000000189d7" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_00000000000189d7"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
print("*"*40)
print("description:")
print("""A stereo IAMF stream encoded using LPCM with a sample rate
of 48 kHz.""")
print("is_valid: True")
