...
no_of_check_items += 1
if "iamd_000000000000795f" in atom_list[12]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stts_00000000000079ec" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stts_00000000000079ec"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000007a0c" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsc_0000000000007a0c"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000007a34" in atom_list[15]:
	pass_count += 1
	atom = atom_list[15]["stco_0000000000007a34"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000007a70" in atom_list[16]:
	pass_count += 1
	atom = atom_list[16]["stsz_0000000000007a70"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
