...
class AacDecoderSpecificInfo(BaseModel):
    ...
    sample_frequency_index: Optional[AacSampleFrequencyIndex]
...
class DecoderConfigAac(BaseModel):
    ...
    stream_type: int
    buffer_size_db: Optional[int]
    max_bitrate: Optional[int]
    average_bit_rate: Optional[int]
...
class FlacMetaBlock(BaseModel):
    ...
    stream_info: Optional[FlacMetaBlockStreamInfo]
    generic_block: Optional[str]
