...
no_of_check_items += 1
if "stts_00000000000002b8" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stts_00000000000002b8"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000002c8" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsc_00000000000002c8"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000002d8" in atom_list[15]:
	pass_count += 1
	atom = atom_list[15]["stco_00000000000002d8"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000000002e8" in atom_list[16]:
	pass_count += 1
	atom = atom_list[16]["stsz_00000000000002e8"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "moof_0000000000000338" in atom_list[17]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "traf_0000000000000350" in atom_list[18]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tfhd_0000000000000358" in atom_list[19]:
	pass_count += 1
	atom = atom_list[19]["tfhd_0000000000000358"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trun_0000000000000380" in atom_list[20]:
	pass_count += 1
	atom = atom_list[20]["trun_0000000000000380"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
		...
		if sub_mixes[0].get("layouts") is not None:
			...
			if layouts[0].get("loudness_layout") is not None:
				...
				if layouts[0]["loudness_layout"].get("ss_layout") is not None:
					pass_count += 1
					no_of_check_items += 1
					if layouts[0]["loudness_layout"]["ss_layout"].get("sound_system") == 11: # SOUND_SYSTEM_11_2_3_0
						pass_count += 1
					else:
						frame = inspect.currentframe()
						print("failure line is #%d."%(frame.f_lineno))
...
print("*"*40)
print("description:")
print("""A simple example of a mono IAMF stream with 1 substream and
no parameter blocks.""")
print("is_valid: True")
