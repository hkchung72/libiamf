...
no_of_check_items += 1
if "stts_00000000000002c1" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["stts_00000000000002c1"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000002d1" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stsc_00000000000002d1"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000002e1" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stco_00000000000002e1"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000000002f1" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsz_00000000000002f1"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "moof_0000000000000341" in atom_list[14]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "traf_0000000000000359" in atom_list[15]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tfhd_0000000000000361" in atom_list[16]:
	pass_count += 1
	atom = atom_list[16]["tfhd_0000000000000361"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trun_0000000000000391" in atom_list[17]:
	pass_count += 1
	atom = atom_list[17]["trun_0000000000000391"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
