...
parser = argparse.ArgumentParser(description="test_000003_s verification script")
...
no_of_check_items += 1
if "iamd_00000000000080ae" in atom_list[10]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stts_000000000000812a" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_000000000000812a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_000000000000814a" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_000000000000814a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000008166" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_0000000000008166"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_000000000000817a" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_000000000000817a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
