...
no_of_check_items += 1
if "stts_0000000000008130" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["stts_0000000000008130"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000008150" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stsc_0000000000008150"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_000000000000816c" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stco_000000000000816c"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000008180" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsz_0000000000008180"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
print("is_valid: True")
print("primary_tested_spec_sections: ['3.2/num_samples_to_trim_at_end', '3.6.2/num_layers', '3.6.2/loudspeaker_layout == Stereo', '3.7.4/default_mix_gain', '3.11.4/LPCM Specific', '4.1/Simple Profile', '5.1/IA Sequence', '5.1.1/Descriptor OBUs', '5.1.2/IA Data OBUs', '6.2.2/edst', '6.2.2/elst', '6.2.2/stts', '6.2.2/trun']")
print("*"*40)
