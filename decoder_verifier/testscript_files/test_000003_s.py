...
no_of_check_items += 1
if "stts_000000000000812c" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_000000000000812c"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_000000000000814c" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_000000000000814c"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000008168" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_0000000000008168"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_000000000000817c" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_000000000000817c"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
