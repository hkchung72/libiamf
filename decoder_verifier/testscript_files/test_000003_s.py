...
no_of_check_items += 1
if "stts_0000000000008126" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["stts_0000000000008126"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000008146" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stsc_0000000000008146"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000008162" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stco_0000000000008162"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000008176" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsz_0000000000008176"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
