...
no_of_check_items += 1
if "stts_0000000000008130" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_0000000000008130"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000008150" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_0000000000008150"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_000000000000816c" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_000000000000816c"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000008180" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_0000000000008180"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
