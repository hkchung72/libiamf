...
parser = argparse.ArgumentParser(description="test_000003 verification script")
...
if "stts_00000000000081ed" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_00000000000081ed"]
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
		frame = inspect.currentframe()
...
if "stsc_000000000000820d" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_000000000000820d"]
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
		frame = inspect.currentframe()
...
if "stsz_000000000000823d" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsz_000000000000823d"]
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
		frame = inspect.currentframe()
	...
	if atom[3]["SampleCount"] == 63:
		...
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
		if atom[4]["EntrySize_0"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[5]["EntrySize_1"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		...
		if atom[8]["EntrySize_4"] == 518:
			...
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[9]["EntrySize_5"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[10]["EntrySize_6"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[11]["EntrySize_7"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[12]["EntrySize_8"] == 518:
			...
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[13]["EntrySize_9"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[14]["EntrySize_10"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[15]["EntrySize_11"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[16]["EntrySize_12"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[17]["EntrySize_13"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[18]["EntrySize_14"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[19]["EntrySize_15"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[20]["EntrySize_16"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[21]["EntrySize_17"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[22]["EntrySize_18"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[23]["EntrySize_19"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[24]["EntrySize_20"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[25]["EntrySize_21"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[26]["EntrySize_22"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[27]["EntrySize_23"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[28]["EntrySize_24"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[29]["EntrySize_25"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[30]["EntrySize_26"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[31]["EntrySize_27"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[32]["EntrySize_28"] == 518:
			...
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[33]["EntrySize_29"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[34]["EntrySize_30"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[35]["EntrySize_31"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[36]["EntrySize_32"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[37]["EntrySize_33"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[38]["EntrySize_34"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[39]["EntrySize_35"] == 518:
			...
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[40]["EntrySize_36"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[41]["EntrySize_37"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[42]["EntrySize_38"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[43]["EntrySize_39"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[44]["EntrySize_40"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[45]["EntrySize_41"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[46]["EntrySize_42"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[47]["EntrySize_43"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[48]["EntrySize_44"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[49]["EntrySize_45"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[50]["EntrySize_46"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[51]["EntrySize_47"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[52]["EntrySize_48"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[53]["EntrySize_49"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[54]["EntrySize_50"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[55]["EntrySize_51"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[56]["EntrySize_52"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[57]["EntrySize_53"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[58]["EntrySize_54"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[59]["EntrySize_55"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[60]["EntrySize_56"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[61]["EntrySize_57"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[62]["EntrySize_58"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[63]["EntrySize_59"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[64]["EntrySize_60"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[65]["EntrySize_61"] == 518:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		if atom[66]["EntrySize_62"] == 522:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
...
if "stco_0000000000008229" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stco_0000000000008229"]
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
		frame = inspect.currentframe()
