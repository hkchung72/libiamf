...
no_of_check_items += 1
if "stts_00000000000002f0" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stts_00000000000002f0"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000000300" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsc_0000000000000300"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000000310" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stco_0000000000000310"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000000320" in atom_list[15]:
	pass_count += 1
	atom = atom_list[15]["stsz_0000000000000320"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "moof_0000000000000370" in atom_list[16]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "traf_0000000000000388" in atom_list[17]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tfhd_0000000000000390" in atom_list[18]:
	pass_count += 1
	atom = atom_list[18]["tfhd_0000000000000390"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trun_00000000000003b8" in atom_list[19]:
	pass_count += 1
	atom = atom_list[19]["trun_00000000000003b8"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
