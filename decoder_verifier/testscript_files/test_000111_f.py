...
parser = argparse.ArgumentParser(description="test_000111_f verification script")
...
no_of_check_items += 1
if "stts_00000000000002d5" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stts_00000000000002d5"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000002e5" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsc_00000000000002e5"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000002f5" in atom_list[15]:
	pass_count += 1
	atom = atom_list[15]["stco_00000000000002f5"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000000305" in atom_list[16]:
	pass_count += 1
	atom = atom_list[16]["stsz_0000000000000305"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "moof_0000000000000355" in atom_list[17]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "traf_000000000000036d" in atom_list[18]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tfhd_0000000000000375" in atom_list[19]:
	pass_count += 1
	atom = atom_list[19]["tfhd_0000000000000375"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trun_000000000000039d" in atom_list[20]:
	pass_count += 1
	atom = atom_list[20]["trun_000000000000039d"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
print("is_valid: True")
print("primary_tested_spec_sections: ['3.6.3/ambisonics_mono_config', '3.11.1/OPUS Specific', '7.5.1/Loudness Normalization', '7.5.2/Limiter']")
print("*"*40)
