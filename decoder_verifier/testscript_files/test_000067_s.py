...
no_of_check_items += 1
if "stts_00000000000084ca" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["stts_00000000000084ca"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000084e2" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stsc_00000000000084e2"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000084fe" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stco_00000000000084fe"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000008512" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsz_0000000000008512"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
