...
parser = argparse.ArgumentParser(description="test_000067_s verification script")
...
if "mvhd_000000000000828f" in atom_list[2]:
	...
	if atom[1]["Flags"] == 0:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[2]["CreationTime"] == "2023-06-28 00:00:00 UTC":
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[3]["ModificationTime"] == "2023-06-28 00:00:00 UTC":
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
...
if "hdlr_0000000000008387" in atom_list[6]:
	...
	if atom[6]["Reserved3"] == 0:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[7]["Name"] == "ISO Media file produced by Google Inc. Created on: 06/27/2023.":
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stts_00000000000084d4" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_00000000000084d4"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000084ec" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_00000000000084ec"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000008508" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_0000000000008508"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_000000000000851c" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_000000000000851c"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
		...
		if sub_mixes[0].get("audio_elements") is not None:
			...
			if audio_elements[0].get("rendering_config") is not None:
				...
				if audio_elements[0]["rendering_config"].get("headphones_rendering_mode") == 0: # HEADPHONES_RENDERING_MODE_STEREO
					...
					print("failure line is #%d."%(frame.f_lineno))
				no_of_check_items += 1
				if audio_elements[0]["rendering_config"].get("rendering_config_extension_size") == 5:
					pass_count += 1
				else:
					frame = inspect.currentframe()
					print("failure line is #%d."%(frame.f_lineno))
...
print("*"*40)
print("description:")
print("""A frame-aligned stereo IAMF stream with extra bytes in
`rendering_config_extension`.""")
print("is_valid: True")
print("primary_tested_spec_sections: ['3.7.3/rendering_config_extension_bytes']")
print("*"*40)
