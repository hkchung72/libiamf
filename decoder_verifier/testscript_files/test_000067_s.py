...
no_of_check_items += 1
if "stts_00000000000084d4" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["stts_00000000000084d4"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000084ec" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stsc_00000000000084ec"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000008508" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stco_0000000000008508"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_000000000000851c" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsz_000000000000851c"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
