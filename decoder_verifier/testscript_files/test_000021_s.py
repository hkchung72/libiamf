...
no_of_check_items += 1
if "moov_0000000000000d8e" in atom_list[1]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "mvhd_0000000000000d96" in atom_list[2]:
	pass_count += 1
	atom = atom_list[2]["mvhd_0000000000000d96"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trak_0000000000000e02" in atom_list[3]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tkhd_0000000000000e0a" in atom_list[4]:
	pass_count += 1
	atom = atom_list[4]["tkhd_0000000000000e0a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "edts_0000000000000e66" in atom_list[5]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "elst_0000000000000e6e" in atom_list[6]:
	pass_count += 1
	atom = atom_list[6]["elst_0000000000000e6e"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "mdhd_0000000000000e92" in atom_list[7]:
	pass_count += 1
	atom = atom_list[7]["mdhd_0000000000000e92"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "hdlr_0000000000000eb2" in atom_list[8]:
	pass_count += 1
	atom = atom_list[8]["hdlr_0000000000000eb2"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stbl_0000000000000f3d" in atom_list[9]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stsd_0000000000000f45" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["stsd_0000000000000f45"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "iamf_0000000000000f55" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["iamf_0000000000000f55"]
	no_of_check_items += 1
	...
	if atom[11]["codec_id"] == "Opus":
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[12]["num_samples_per_frame"] == 1920:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stts_0000000000000ff8" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stts_0000000000000ff8"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000001018" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsc_0000000000001018"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000001040" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stco_0000000000001040"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000001058" in atom_list[15]:
	pass_count += 1
	atom = atom_list[15]["stsz_0000000000001058"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
	...
	if atom[3]["SampleCount"] == 13:
		...
		print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if atom[4]["EntrySize_0"] == 346:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if atom[5]["EntrySize_1"] == 287:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if atom[6]["EntrySize_2"] == 254:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "sgpd_00000000000010a0" in atom_list[16]:
	pass_count += 1
	atom = atom_list[16]["sgpd_00000000000010a0"]
	no_of_check_items += 1
	if atom[0]["Version"] == 1:
		pass_count += 1
	else:
