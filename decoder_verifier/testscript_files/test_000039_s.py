...
no_of_check_items += 1
if "stts_00000000000c0c99" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["stts_00000000000c0c99"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000c0cb1" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stsc_00000000000c0cb1"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000c0ccd" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stco_00000000000c0ccd"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000000c0ce1" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsz_00000000000c0ce1"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
