...
no_of_check_items += 1
if "stts_00000000000c0c99" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_00000000000c0c99"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000c0cb1" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_00000000000c0cb1"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000c0ccd" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_00000000000c0ccd"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000000c0ce1" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_00000000000c0ce1"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
print("is_valid: True")
print("primary_tested_spec_sections: ['3.6.3/ambisonics_mono_config', '7/IAMF Processing', '7.1/channel_mapping', '7.3.2/Rendering an Audio Element', '7.3.2.2/Rendering a Scene-Based Audio Element to Loudspeakers']")
print("*"*40)
