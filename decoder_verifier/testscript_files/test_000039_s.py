...
parser = argparse.ArgumentParser(description="test_000039_s verification script")
...
no_of_check_items += 1
if "stts_00000000000c0e3b" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_00000000000c0e3b"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000c0e53" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_00000000000c0e53"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000c0e6f" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_00000000000c0e6f"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000000c0e83" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_00000000000c0e83"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
print("is_valid: True")
print("primary_tested_spec_sections: ['3.7.3/ambisonics_mono_config']")
print("*"*40)
