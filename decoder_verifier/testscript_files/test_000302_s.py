...
parser = argparse.ArgumentParser(description="test_000302_s verification script")
...
no_of_check_items += 1
if "iacb_000000000086c301" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["iacb_000000000086c301"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "stts_000000000086c3de" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_000000000086c3de"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_000000000086c3f6" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_000000000086c3f6"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_000000000086c412" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_000000000086c412"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_000000000086c44a" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_000000000086c44a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
print("is_valid: True")
print("primary_tested_spec_sections: ['3.6.2/loudspeaker_layout == Stereo', '3.6.3/ambisonics_mono_config', '3.7.4/default_mix_gain', '4.2/Base Profile', '8.5.1/Loudness Information']")
print("*"*40)
