...
no_of_check_items += 1
if "moov_000000000002443c" in atom_list[1]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "mvhd_0000000000024444" in atom_list[2]:
	pass_count += 1
	atom = atom_list[2]["mvhd_0000000000024444"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trak_00000000000244b0" in atom_list[3]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tkhd_00000000000244b8" in atom_list[4]:
	pass_count += 1
	atom = atom_list[4]["tkhd_00000000000244b8"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "mdhd_000000000002451c" in atom_list[5]:
	pass_count += 1
	atom = atom_list[5]["mdhd_000000000002451c"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "hdlr_000000000002453c" in atom_list[6]:
	pass_count += 1
	atom = atom_list[6]["hdlr_000000000002453c"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stbl_00000000000245c7" in atom_list[7]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stsd_00000000000245cf" in atom_list[8]:
	pass_count += 1
	atom = atom_list[8]["stsd_00000000000245cf"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "iamf_00000000000245df" in atom_list[9]:
	pass_count += 1
	atom = atom_list[9]["iamf_00000000000245df"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "iamd_0000000000024603" in atom_list[10]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stts_0000000000024685" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_0000000000024685"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_000000000002469d" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_000000000002469d"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000246b9" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_00000000000246b9"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000000246cd" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_00000000000246cd"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
print("is_valid: True")
print("primary_tested_spec_sections: ['3.10', '3.13.4/sample_size']")
print("*"*40)
