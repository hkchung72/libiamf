...
parser = argparse.ArgumentParser(description="test_000031_s verification script")
...
no_of_check_items += 1
if "moov_00000000000242c5" in atom_list[1]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "mvhd_00000000000242cd" in atom_list[2]:
	pass_count += 1
	atom = atom_list[2]["mvhd_00000000000242cd"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trak_0000000000024339" in atom_list[3]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tkhd_0000000000024341" in atom_list[4]:
	pass_count += 1
	atom = atom_list[4]["tkhd_0000000000024341"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "mdhd_00000000000243a5" in atom_list[5]:
	pass_count += 1
	atom = atom_list[5]["mdhd_00000000000243a5"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "hdlr_00000000000243c5" in atom_list[6]:
	pass_count += 1
	atom = atom_list[6]["hdlr_00000000000243c5"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stbl_0000000000024450" in atom_list[7]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stsd_0000000000024458" in atom_list[8]:
	pass_count += 1
	atom = atom_list[8]["stsd_0000000000024458"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "iamf_0000000000024468" in atom_list[9]:
	pass_count += 1
	atom = atom_list[9]["iamf_0000000000024468"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "iacb_000000000002448c" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["iacb_000000000002448c"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "stts_000000000002450f" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_000000000002450f"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000024527" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_0000000000024527"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000024543" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_0000000000024543"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000024557" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_0000000000024557"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
	...
	if obu.get("codec_config") is not None:
		...
		if obu["codec_config"].get("decoder_config_lpcm") is not None:
			...
			if obu["codec_config"]["decoder_config_lpcm"].get("sample_format_flags") == 1: # LPCM_LITTLE_ENDIAN
				...
				print("failure line is #%d."%(frame.f_lineno))
			no_of_check_items += 1
			if obu["codec_config"]["decoder_config_lpcm"].get("sample_size") == 24:
				pass_count += 1
			else:
				frame = inspect.currentframe()
				print("failure line is #%d."%(frame.f_lineno))
...
print("*"*40)
print("description:")
print("""A stereo IAMF stream with a bit-depth of 24.""")
print("is_valid: True")
print("primary_tested_spec_sections: ['3.9/Audio Frame OBU Syntax and Semantics', '3.11.4/sample_size']")
print("*"*40)
