...
no_of_check_items += 1
if "stts_0000000000024682" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_0000000000024682"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_000000000002469a" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_000000000002469a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000246b6" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_00000000000246b6"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000000246ca" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_00000000000246ca"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
print("is_valid: True")
print("primary_tested_spec_sections: ['2.10', '2.12.4/sample_size']")
print("*"*40)
