...
parser = argparse.ArgumentParser(description="test_000300_s verification script")
...
no_of_check_items += 1
if "iacb_00000000002ccfa9" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["iacb_00000000002ccfa9"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "stts_00000000002cd06e" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_00000000002cd06e"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000002cd086" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_00000000002cd086"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000002cd0a2" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_00000000002cd0a2"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000002cd0da" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_00000000002cd0da"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
