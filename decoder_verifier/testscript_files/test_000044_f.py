...
parser = argparse.ArgumentParser(description="test_000044_f verification script")
...
no_of_check_items += 1
if "stts_000000000000030f" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_000000000000030f"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_000000000000031f" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_000000000000031f"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_000000000000032f" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_000000000000032f"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_000000000000033f" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_000000000000033f"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "moof_000000000000038f" in atom_list[15]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "traf_00000000000003a7" in atom_list[16]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tfhd_00000000000003af" in atom_list[17]:
	pass_count += 1
	atom = atom_list[17]["tfhd_00000000000003af"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
	...
	if atom[4]["DefaultSampleDuration"] == 64:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[5]["DefaultSampleSize"] == 532:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "trun_00000000000003df" in atom_list[18]:
	pass_count += 1
	atom = atom_list[18]["trun_00000000000003df"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
