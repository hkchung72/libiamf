...
parser = argparse.ArgumentParser(description="test_000302_f verification script")
...
no_of_check_items += 1
if "stts_00000000000002e4" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_00000000000002e4"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000002f4" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_00000000000002f4"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000000304" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_0000000000000304"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000000314" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_0000000000000314"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "moof_0000000000000364" in atom_list[15]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "traf_000000000000037c" in atom_list[16]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tfhd_0000000000000384" in atom_list[17]:
	pass_count += 1
	atom = atom_list[17]["tfhd_0000000000000384"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trun_00000000000003b4" in atom_list[18]:
	pass_count += 1
	atom = atom_list[18]["trun_00000000000003b4"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
