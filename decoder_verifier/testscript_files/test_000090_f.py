...
parser = argparse.ArgumentParser(description="test_000090_f verification script")
...
print("*"*40)
print("description:")
print("""A stereo IAMF stream encoded with AAC and
`num_samples_to_trim_at_end != 0`.""")
print("is_valid: True")
print("primary_tested_spec_sections: ['3.2/num_samples_to_trim_at_end', '3.5/Codec Config OBU Syntax and Semantics', '3.11.2/AAC-LC Specific']")
print("*"*40)
