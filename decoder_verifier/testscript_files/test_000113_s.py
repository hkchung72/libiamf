...
no_of_check_items += 1
if "iamd_000000000001d131" in atom_list[12]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stts_000000000001d1db" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stts_000000000001d1db"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_000000000001d1fb" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsc_000000000001d1fb"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_000000000001d223" in atom_list[15]:
	pass_count += 1
	atom = atom_list[15]["stco_000000000001d223"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_000000000001d25f" in atom_list[16]:
	pass_count += 1
	atom = atom_list[16]["stsz_000000000001d25f"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
