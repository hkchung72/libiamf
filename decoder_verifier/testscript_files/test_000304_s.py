...
parser = argparse.ArgumentParser(description="test_000304_s verification script")
...
no_of_check_items += 1
if "moov_0000000000050421" in atom_list[1]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "mvhd_0000000000050429" in atom_list[2]:
	pass_count += 1
	atom = atom_list[2]["mvhd_0000000000050429"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trak_0000000000050495" in atom_list[3]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tkhd_000000000005049d" in atom_list[4]:
	pass_count += 1
	atom = atom_list[4]["tkhd_000000000005049d"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "edts_00000000000504f9" in atom_list[5]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "elst_0000000000050501" in atom_list[6]:
	pass_count += 1
	atom = atom_list[6]["elst_0000000000050501"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "mdhd_0000000000050525" in atom_list[7]:
	pass_count += 1
	atom = atom_list[7]["mdhd_0000000000050525"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "hdlr_0000000000050545" in atom_list[8]:
	pass_count += 1
	atom = atom_list[8]["hdlr_0000000000050545"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stbl_00000000000505d0" in atom_list[9]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stsd_00000000000505d8" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["stsd_00000000000505d8"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "iamf_00000000000505e8" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["iamf_00000000000505e8"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "iacb_000000000005060c" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["iacb_000000000005060c"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "stts_00000000000506e1" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stts_00000000000506e1"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000050701" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsc_0000000000050701"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000050729" in atom_list[15]:
	pass_count += 1
	atom = atom_list[15]["stco_0000000000050729"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
	...
	if atom[2]["EntryCount"] == 11:
		...
		if atom[4]["ChunkOffset_1"] == 33709:
			...
			print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if atom[5]["ChunkOffset_2"] == 66440:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if atom[6]["ChunkOffset_3"] == 98835:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if atom[7]["ChunkOffset_4"] == 131088:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if atom[8]["ChunkOffset_5"] == 163205:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if atom[9]["ChunkOffset_6"] == 195928:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if atom[10]["ChunkOffset_7"] == 229340:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if atom[11]["ChunkOffset_8"] == 262271:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if atom[12]["ChunkOffset_9"] == 295203:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if atom[13]["ChunkOffset_10"] == 327223:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stsz_0000000000050765" in atom_list[16]:
	pass_count += 1
	atom = atom_list[16]["stsz_0000000000050765"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "sgpd_0000000000050b65" in atom_list[17]:
	pass_count += 1
	atom = atom_list[17]["sgpd_0000000000050b65"]
	no_of_check_items += 1
	if atom[0]["Version"] == 1:
		pass_count += 1
	else:
