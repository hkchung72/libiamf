...
parser = argparse.ArgumentParser(description="test_000111_s verification script")
...
no_of_check_items += 1
if "stts_0000000000074305" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stts_0000000000074305"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000074325" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsc_0000000000074325"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_000000000007434d" in atom_list[15]:
	pass_count += 1
	atom = atom_list[15]["stco_000000000007434d"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000074389" in atom_list[16]:
	pass_count += 1
	atom = atom_list[16]["stsz_0000000000074389"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "sgpd_0000000000074789" in atom_list[17]:
	pass_count += 1
	atom = atom_list[17]["sgpd_0000000000074789"]
	no_of_check_items += 1
	if atom[0]["Version"] == 1:
		pass_count += 1
	else:
