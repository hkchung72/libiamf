...
no_of_check_items += 1
if "stts_000000000004177c" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stts_000000000004177c"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_000000000004179c" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsc_000000000004179c"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000417c4" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stco_00000000000417c4"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000041800" in atom_list[15]:
	pass_count += 1
	atom = atom_list[15]["stsz_0000000000041800"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "sgpd_0000000000041c00" in atom_list[16]:
	pass_count += 1
	atom = atom_list[16]["sgpd_0000000000041c00"]
	no_of_check_items += 1
	if atom[0]["Version"] == 1:
		pass_count += 1
	else:
