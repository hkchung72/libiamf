...
no_of_check_items += 1
if "stco_00000000000002a7" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_00000000000002a7"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000000002b7" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_00000000000002b7"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "moof_0000000000000307" in atom_list[15]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "traf_000000000000031f" in atom_list[16]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tfhd_0000000000000327" in atom_list[17]:
	pass_count += 1
	atom = atom_list[17]["tfhd_0000000000000327"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trun_000000000000034f" in atom_list[18]:
	pass_count += 1
	atom = atom_list[18]["trun_000000000000034f"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
print("is_valid: True")
print("primary_tested_spec_sections: ['2.8/element_mix_config', '2.8.4/default_mix_gain']")
print("*"*40)
