...
if "iamf_00000000000001e3" in atom_list[9]:
	...
	if atom[11]["codec_id"] == "ipcm":
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[12]["num_samples_per_frame"] == 128:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stts_0000000000000281" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["stts_0000000000000281"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000000291" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stsc_0000000000000291"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000002a1" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stco_00000000000002a1"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000000002b1" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsz_00000000000002b1"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "moof_0000000000000301" in atom_list[14]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "traf_0000000000000319" in atom_list[15]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tfhd_0000000000000321" in atom_list[16]:
	pass_count += 1
	atom = atom_list[16]["tfhd_0000000000000321"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trun_0000000000000349" in atom_list[17]:
	pass_count += 1
	atom = atom_list[17]["trun_0000000000000349"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
