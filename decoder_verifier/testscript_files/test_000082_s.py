...
no_of_check_items += 1
if "stts_0000000000583996" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["stts_0000000000583996"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000005839b6" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stsc_00000000005839b6"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000005839de" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stco_00000000005839de"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000583a1a" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsz_0000000000583a1a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
