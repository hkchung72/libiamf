...
parser = argparse.ArgumentParser(description="test_000015 verification script")
...
if "stsz_00000000000089fb" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsz_00000000000089fb"]
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
		frame = inspect.currentframe()
...
if "stco_00000000000089e7" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stco_00000000000089e7"]
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
		frame = inspect.currentframe()
