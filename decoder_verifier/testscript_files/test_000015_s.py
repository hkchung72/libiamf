...
parser = argparse.ArgumentParser(description="test_000015_s verification script")
...
no_of_check_items += 1
if "moov_000000000000866f" in atom_list[1]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "mvhd_0000000000008677" in atom_list[2]:
	pass_count += 1
	atom = atom_list[2]["mvhd_0000000000008677"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trak_00000000000086e3" in atom_list[3]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tkhd_00000000000086eb" in atom_list[4]:
	pass_count += 1
	atom = atom_list[4]["tkhd_00000000000086eb"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "mdhd_000000000000874f" in atom_list[5]:
	pass_count += 1
	atom = atom_list[5]["mdhd_000000000000874f"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "hdlr_000000000000876f" in atom_list[6]:
	pass_count += 1
	atom = atom_list[6]["hdlr_000000000000876f"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stbl_00000000000087fa" in atom_list[7]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stsd_0000000000008802" in atom_list[8]:
	pass_count += 1
	atom = atom_list[8]["stsd_0000000000008802"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "iamf_0000000000008812" in atom_list[9]:
	pass_count += 1
	atom = atom_list[9]["iamf_0000000000008812"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "iacb_0000000000008836" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["iacb_0000000000008836"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "stts_00000000000088b7" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_00000000000088b7"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000088cf" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_00000000000088cf"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000088eb" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_00000000000088eb"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000000088ff" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_00000000000088ff"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
print("*"*40)
print("description:")
print("""A stereo IAMF stream that includes an extra parameter block
which is not used by any audio element.""")
print("is_valid: True")
print("primary_tested_spec_sections: ['3.8/parameter_id']")
print("*"*40)
