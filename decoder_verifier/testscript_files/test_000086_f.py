...
parser = argparse.ArgumentParser(description="test_000086_f verification script")
...
no_of_check_items += 1
if "stts_00000000000002f1" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_00000000000002f1"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000000301" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_0000000000000301"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000000311" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_0000000000000311"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000000321" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_0000000000000321"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "moof_0000000000000371" in atom_list[15]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "traf_0000000000000389" in atom_list[16]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tfhd_0000000000000391" in atom_list[17]:
	pass_count += 1
	atom = atom_list[17]["tfhd_0000000000000391"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
	...
	if atom[4]["DefaultSampleDuration"] == 64:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[5]["DefaultSampleSize"] == 1563:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "trun_00000000000003c1" in atom_list[18]:
	pass_count += 1
	atom = atom_list[18]["trun_00000000000003c1"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
