...
no_of_check_items += 1
if "stts_00000000000002c7" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stts_00000000000002c7"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000002d7" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsc_00000000000002d7"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000002e7" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stco_00000000000002e7"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000000002f7" in atom_list[15]:
	pass_count += 1
	atom = atom_list[15]["stsz_00000000000002f7"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "moof_0000000000000347" in atom_list[16]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "traf_000000000000035f" in atom_list[17]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tfhd_0000000000000367" in atom_list[18]:
	pass_count += 1
	atom = atom_list[18]["tfhd_0000000000000367"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trun_000000000000038f" in atom_list[19]:
	pass_count += 1
	atom = atom_list[19]["trun_000000000000038f"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
