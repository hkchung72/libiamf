...
no_of_check_items += 1
if "iacb_00000000000084cb" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["iacb_00000000000084cb"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "stts_000000000000854c" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_000000000000854c"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000008564" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_0000000000008564"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000008580" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_0000000000008580"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000008594" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_0000000000008594"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
print("is_valid: True")
print("primary_tested_spec_sections: ['3.1/obu_type', '3.9/explicit_audio_substream_id']")
print("*"*40)
