...
no_of_check_items += 1
if "stts_00000000000085c5" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_00000000000085c5"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000085dd" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_00000000000085dd"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000085f9" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_00000000000085f9"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_000000000000860d" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_000000000000860d"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
print("is_valid: True")
print("primary_tested_spec_sections: ['2.1/obu_type', '2.10/explicit_audio_substream_id']")
print("*"*40)
