...
parser = argparse.ArgumentParser(description="test_000018_s verification script")
...
no_of_check_items += 1
if "moov_0000000000008381" in atom_list[1]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "mvhd_0000000000008389" in atom_list[2]:
	pass_count += 1
	atom = atom_list[2]["mvhd_0000000000008389"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trak_00000000000083f5" in atom_list[3]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tkhd_00000000000083fd" in atom_list[4]:
	pass_count += 1
	atom = atom_list[4]["tkhd_00000000000083fd"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "mdhd_0000000000008461" in atom_list[5]:
	pass_count += 1
	atom = atom_list[5]["mdhd_0000000000008461"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "hdlr_0000000000008481" in atom_list[6]:
	pass_count += 1
	atom = atom_list[6]["hdlr_0000000000008481"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stbl_000000000000850c" in atom_list[7]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stsd_0000000000008514" in atom_list[8]:
	pass_count += 1
	atom = atom_list[8]["stsd_0000000000008514"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "iamf_0000000000008524" in atom_list[9]:
	pass_count += 1
	atom = atom_list[9]["iamf_0000000000008524"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "iamd_0000000000008548" in atom_list[10]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stts_00000000000085c8" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_00000000000085c8"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000000085e0" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_00000000000085e0"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000085fc" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_00000000000085fc"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000008610" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_0000000000008610"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
print("*"*40)
print("description:")
print("""A stereo IAMF stream. The substream has an ID larger than 21
which requires the ID to be explicitly listed in the OBU.""")
print("is_valid: True")
print("primary_tested_spec_sections: ['3.2/obu_type', '3.10/audio_frame_obu_with_no_id']")
print("*"*40)
