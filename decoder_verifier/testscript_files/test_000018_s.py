...
no_of_check_items += 1
if "stts_0000000000008542" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["stts_0000000000008542"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_000000000000855a" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stsc_000000000000855a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000008576" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stco_0000000000008576"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_000000000000858a" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsz_000000000000858a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
