...
parser = argparse.ArgumentParser(description="test_000018 verification script")
...
if "stsz_0000000000008610" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsz_0000000000008610"]
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
		frame = inspect.currentframe()
...
if "stco_00000000000085fc" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stco_00000000000085fc"]
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
		frame = inspect.currentframe()
