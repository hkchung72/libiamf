...
no_of_check_items += 1
if "moov_000000000005825c" in atom_list[0]:
	pass_count += 1
else:
...
no_of_check_items += 1
if "mvhd_0000000000058264" in atom_list[1]:
	pass_count += 1
	atom = atom_list[1]["mvhd_0000000000058264"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trak_00000000000582d0" in atom_list[2]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tkhd_00000000000582d8" in atom_list[3]:
	pass_count += 1
	atom = atom_list[3]["tkhd_00000000000582d8"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "edts_0000000000058334" in atom_list[4]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "elst_000000000005833c" in atom_list[5]:
	pass_count += 1
	atom = atom_list[5]["elst_000000000005833c"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "mdhd_0000000000058360" in atom_list[6]:
	pass_count += 1
	atom = atom_list[6]["mdhd_0000000000058360"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "hdlr_0000000000058380" in atom_list[7]:
	pass_count += 1
	atom = atom_list[7]["hdlr_0000000000058380"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stbl_000000000005840b" in atom_list[8]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stsd_0000000000058413" in atom_list[9]:
	pass_count += 1
	atom = atom_list[9]["stsd_0000000000058413"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "iamf_0000000000058423" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["iamf_0000000000058423"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "iacb_0000000000058447" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["iacb_0000000000058447"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "stts_0000000000058505" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stts_0000000000058505"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000058525" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsc_0000000000058525"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_000000000005854d" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stco_000000000005854d"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
	...
	if atom[2]["EntryCount"] == 11:
		...
		if atom[5]["ChunkOffset_2"] == 71289:
			...
			print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if atom[6]["ChunkOffset_3"] == 106827:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		...
		if atom[11]["ChunkOffset_8"] == 286792:
			...
			print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if atom[12]["ChunkOffset_9"] == 322835:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stsz_0000000000058589" in atom_list[15]:
	pass_count += 1
	atom = atom_list[15]["stsz_0000000000058589"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
	...
	if atom[3]["SampleCount"] == 251:
		...
		if atom[206]["EntrySize_202"] == 1519:
			...
			print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if atom[207]["EntrySize_203"] == 1435:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
		...
		if atom[231]["EntrySize_227"] == 1438:
			...
			print("failure line is #%d."%(frame.f_lineno))
		no_of_check_items += 1
		if atom[232]["EntrySize_228"] == 1436:
			pass_count += 1
		else:
			frame = inspect.currentframe()
			print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "sgpd_0000000000058989" in atom_list[16]:
	pass_count += 1
	atom = atom_list[16]["sgpd_0000000000058989"]
	no_of_check_items += 1
	if atom[0]["Version"] == 1:
		pass_count += 1
	else:
