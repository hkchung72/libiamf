...
no_of_check_items += 1
if "stts_00000000005835ea" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["stts_00000000005835ea"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_000000000058360a" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stsc_000000000058360a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000583632" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stco_0000000000583632"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_000000000058366e" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsz_000000000058366e"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
