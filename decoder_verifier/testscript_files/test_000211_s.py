...
parser = argparse.ArgumentParser(description="test_000211_s verification script")
...
no_of_check_items += 1
if "stts_00000000005835ea" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_00000000005835ea"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_000000000058360a" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_000000000058360a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000583632" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_0000000000583632"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_000000000058366e" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_000000000058366e"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
