...
no_of_check_items += 1
if "stts_000000000001d1be" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stts_000000000001d1be"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_000000000001d1de" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsc_000000000001d1de"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_000000000001d206" in atom_list[15]:
	pass_count += 1
	atom = atom_list[15]["stco_000000000001d206"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_000000000001d242" in atom_list[16]:
	pass_count += 1
	atom = atom_list[16]["stsz_000000000001d242"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
