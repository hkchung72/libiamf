...
parser = argparse.ArgumentParser(description="test_000109_s verification script")
...
no_of_check_items += 1
if "stts_000000000001d1c3" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stts_000000000001d1c3"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_000000000001d1e3" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsc_000000000001d1e3"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_000000000001d20b" in atom_list[15]:
	pass_count += 1
	atom = atom_list[15]["stco_000000000001d20b"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_000000000001d247" in atom_list[16]:
	pass_count += 1
	atom = atom_list[16]["stsz_000000000001d247"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "sgpd_000000000001d647" in atom_list[17]:
	pass_count += 1
	atom = atom_list[17]["sgpd_000000000001d647"]
	no_of_check_items += 1
	if atom[0]["Version"] == 1:
		pass_count += 1
	else:
