...
parser = argparse.ArgumentParser(description="test_000006_f verification script")
...
no_of_check_items += 1
if "trun_0000000000000358" in atom_list[18]:
	pass_count += 1
	atom = atom_list[18]["trun_0000000000000358"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
