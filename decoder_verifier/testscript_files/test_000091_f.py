...
parser = argparse.ArgumentParser(description="test_000091_f verification script")
...
no_of_check_items += 1
if "trun_0000000000000387" in atom_list[20]:
	pass_count += 1
	atom = atom_list[20]["trun_0000000000000387"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
