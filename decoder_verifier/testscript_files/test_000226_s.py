...
no_of_check_items += 1
if "stts_00000000005835ef" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["stts_00000000005835ef"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_000000000058360f" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stsc_000000000058360f"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000583637" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stco_0000000000583637"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000583673" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsz_0000000000583673"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
