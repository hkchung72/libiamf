...
no_of_check_items += 1
if "stts_0000000000030de2" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["stts_0000000000030de2"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000030dfa" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stsc_0000000000030dfa"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000030e16" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stco_0000000000030e16"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000030e2a" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsz_0000000000030e2a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
