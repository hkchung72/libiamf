...
no_of_check_items += 1
if "iamd_00000000000324da" in atom_list[12]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "stts_000000000003257b" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stts_000000000003257b"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_000000000003259b" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsc_000000000003259b"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000325c3" in atom_list[15]:
	pass_count += 1
	atom = atom_list[15]["stco_00000000000325c3"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000000325ff" in atom_list[16]:
	pass_count += 1
	atom = atom_list[16]["stsz_00000000000325ff"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
