...
parser = argparse.ArgumentParser(description="test_000102_s verification script")
...
no_of_check_items += 1
if "stts_000000000042336a" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_000000000042336a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_000000000042338a" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_000000000042338a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000004233b2" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_00000000004233b2"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000004233ee" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_00000000004233ee"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
