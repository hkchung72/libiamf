...
parser = argparse.ArgumentParser(description="test_000407_s verification script")
...
no_of_check_items += 1
if "iacb_00000000001d719a" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["iacb_00000000001d719a"]
	no_of_check_items += 1
...
no_of_check_items += 1
if "stts_00000000001d725a" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_00000000001d725a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_00000000001d727a" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_00000000001d727a"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000001d72a2" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_00000000001d72a2"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000001d72de" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_00000000001d72de"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
