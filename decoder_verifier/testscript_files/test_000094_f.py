...
parser = argparse.ArgumentParser(description="test_000094_f verification script")
...
if "trun_00000000000003a1" in atom_list[20]:
	...
	if atom[24]["SampleDuration_10"] == 1024:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[25]["SampleSize_10"] == 12346:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[26]["SampleDuration_11"] == 1024:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[27]["SampleSize_11"] == 12346:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[28]["SampleDuration_12"] == 1024:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[29]["SampleSize_12"] == 12346:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[30]["SampleDuration_13"] == 1024:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[31]["SampleSize_13"] == 12346:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[32]["SampleDuration_14"] == 1024:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[33]["SampleSize_14"] == 12346:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[34]["SampleDuration_15"] == 1024:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[35]["SampleSize_15"] == 12346:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[36]["SampleDuration_16"] == 1024:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[37]["SampleSize_16"] == 12346:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[38]["SampleDuration_17"] == 1024:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[39]["SampleSize_17"] == 12346:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[40]["SampleDuration_18"] == 1024:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[41]["SampleSize_18"] == 12346:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[42]["SampleDuration_19"] == 1024:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[43]["SampleSize_19"] == 12346:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[44]["SampleDuration_20"] == 1024:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[45]["SampleSize_20"] == 12346:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[46]["SampleDuration_21"] == 1024:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[47]["SampleSize_21"] == 12346:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[48]["SampleDuration_22"] == 1024:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[49]["SampleSize_22"] == 12346:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[50]["SampleDuration_23"] == 1024:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[51]["SampleSize_23"] == 12346:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	...
	if atom[52]["SampleDuration_24"] == 1024:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[53]["SampleSize_24"] == 12346:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[54]["SampleDuration_25"] == 448:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[55]["SampleSize_25"] == 12394:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
...
print("is_valid: True")
print("primary_tested_spec_sections: ['3.6.3/ambisonics_mono_config', '3.11.2/AAC-LC Specific', '7/IAMF Processing', '7.1/channel_mapping', '7.3.2/Rendering an Audio Element', '7.3.2.2/Rendering a Scene-Based Audio Element to Loudspeakers']")
print("*"*40)
