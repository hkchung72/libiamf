...
no_of_check_items += 1
if "stts_0000000000000288" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["stts_0000000000000288"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000000298" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stsc_0000000000000298"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000002a8" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stco_00000000000002a8"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "moof_0000000000000308" in atom_list[14]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "traf_0000000000000320" in atom_list[15]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tfhd_0000000000000328" in atom_list[16]:
	pass_count += 1
	atom = atom_list[16]["tfhd_0000000000000328"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trun_0000000000000350" in atom_list[17]:
	pass_count += 1
	atom = atom_list[17]["trun_0000000000000350"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
