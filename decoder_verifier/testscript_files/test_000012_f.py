...
no_of_check_items += 1
if "stts_0000000000000284" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_0000000000000284"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000000294" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_0000000000000294"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_00000000000002a4" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_00000000000002a4"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_00000000000002b4" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_00000000000002b4"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "moof_0000000000000304" in atom_list[15]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "traf_000000000000031c" in atom_list[16]:
	pass_count += 1
else:
	frame = inspect.currentframe()
	print("failure line is #%d."%(frame.f_lineno))
...
no_of_check_items += 1
if "tfhd_0000000000000324" in atom_list[17]:
	pass_count += 1
	atom = atom_list[17]["tfhd_0000000000000324"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "trun_000000000000034c" in atom_list[18]:
	pass_count += 1
	atom = atom_list[18]["trun_000000000000034c"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
	...
	if atom[252]["SampleDuration_124"] == 62:
		...
		print("failure line is #%d."%(frame.f_lineno))
	no_of_check_items += 1
	if atom[253]["SampleSize_124"] == 270:
		pass_count += 1
	else:
		frame = inspect.currentframe()
		print("failure line is #%d."%(frame.f_lineno))
...
print("is_valid: True")
print("primary_tested_spec_sections: ['2.2/num_samples_to_trim_at_end']")
print("*"*40)
