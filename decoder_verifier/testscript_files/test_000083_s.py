...
no_of_check_items += 1
if "stts_0000000000030dc4" in atom_list[10]:
	pass_count += 1
	atom = atom_list[10]["stts_0000000000030dc4"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000030ddc" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stsc_0000000000030ddc"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000030df8" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stco_0000000000030df8"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000030e0c" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stsz_0000000000030e0c"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
