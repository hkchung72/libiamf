...
parser = argparse.ArgumentParser(description="test_000083_s verification script")
...
no_of_check_items += 1
if "stts_0000000000030dc4" in atom_list[11]:
	pass_count += 1
	atom = atom_list[11]["stts_0000000000030dc4"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsc_0000000000030ddc" in atom_list[12]:
	pass_count += 1
	atom = atom_list[12]["stsc_0000000000030ddc"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stco_0000000000030df8" in atom_list[13]:
	pass_count += 1
	atom = atom_list[13]["stco_0000000000030df8"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
no_of_check_items += 1
if "stsz_0000000000030e0c" in atom_list[14]:
	pass_count += 1
	atom = atom_list[14]["stsz_0000000000030e0c"]
	no_of_check_items += 1
	if atom[0]["Version"] == 0:
		pass_count += 1
	else:
...
== 1`.""")
print("is_valid: True")
print("primary_tested_spec_sections: ['3.6.3/ambisonics_mono_config', '3.7.3/headphones_rendering_mode == 1', '7/IAMF Processing', '7.3.2/Rendering an Audio Element', '7.3.2.4/Rendering a Scene-Based Audio Element to Headphones']")
print("*"*40)
